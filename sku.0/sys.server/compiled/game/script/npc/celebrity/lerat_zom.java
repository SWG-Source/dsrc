...
public class lerat_zom extends script.base_script
{
    ...
    {
        obj_id shirt = createObject("object/tangible/wearables/shirt/shirt_s03.iff", self, "");
        ...
        obj_id hair = createObject("object/tangible/hair/human/hair_human_male_s10.iff", self, "");
        hue.setColor(shirt, 1, 254);
        hue.setColor(pants, 1, 90);
        hue.setColor(hair, 1, 9);
        setName(self, "Lerat Zom");
        ai_lib.setDefaultCalmBehavior(self, ai_lib.BEHAVIOR_SENTINEL);
        debugSpeakMsg(self, "Oh, so you made that up, eh?");
