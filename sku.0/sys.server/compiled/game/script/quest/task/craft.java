...
public class craft extends script.base_script
{
	...
	public int OnCraftedPrototype(obj_id self, obj_id prototypeObject, draft_schematic manufacturingSchematic) throws InterruptedException
	{
		...
		sendSystemMessageTestingOnly(player, "Crafted!!!!!!!!!!!!!!!!!!!");
		
		LOG("crafting_counter", "testing messageto logging!");
		dictionary params = new dictionary();
		params.put("tempParam", player);
		messageTo(player, "receiveCollectionCreditForCrafting", params, 0.0f, false);
