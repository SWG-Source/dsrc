...
public class slaver_elevator_down_4 extends script.base_script
{
    public slaver_elevator_down_4()
    {
    }
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        {
            if (!groundquests.hasCompletedTask(player, "corellia_tyrena_slaver_access", "hack_term_4a"))
            {
