...
public class refined_ardanium_ii extends script.systems.crafting.community_crafting.component.base_component
{
    public refined_ardanium_ii()
    {
    }
    ...
    {
        new resource_weight("res_potential_energy", new resource_weight.weight[]
        {
