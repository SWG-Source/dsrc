...
public class power_supply extends script.systems.crafting.community_crafting.component.base_component
{
    public power_supply()
    {
    }
    ...
    {
        new resource_weight("energy_resistance", new resource_weight.weight[]
        {
