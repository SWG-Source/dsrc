...
public class crafting_weapon_computer_component extends script.systems.crafting.weapon.crafting_base_weapon_component
{
    public crafting_weapon_computer_component()
    {
    }
