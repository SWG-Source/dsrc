...
public class crafting_power_handler_component extends script.systems.crafting.weapon.crafting_base_weapon_component
{
    public crafting_power_handler_component()
    {
    }
