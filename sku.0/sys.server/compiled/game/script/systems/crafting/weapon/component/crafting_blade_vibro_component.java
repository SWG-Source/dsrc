...
public class crafting_blade_vibro_component extends script.systems.crafting.weapon.crafting_base_weapon_component
{
    public crafting_blade_vibro_component()
    {
    }
