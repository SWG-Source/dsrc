...
public class crafting_chem_dispersion_component extends script.systems.crafting.weapon.crafting_base_weapon_component
{
    public crafting_chem_dispersion_component()
    {
    }
