...
public class crafting_blaster_energy_component extends script.systems.crafting.weapon.crafting_base_weapon_component
{
    public crafting_blaster_energy_component()
    {
    }
    ...
    public static final resource_weight[] OBJ_ASSEMBLY_ATTRIBUTE_RESOURCES = 
    {
        ...
        new resource_weight("roundsUsed", new resource_weight.weight[]
        {
            new resource_weight.weight(craftinglib.RESOURCE_CONDUCTIVITY, 1)
        }),
