...
public class crafting_galven_tube_component extends script.systems.crafting.weapon.crafting_base_weapon_component
{
    public crafting_galven_tube_component()
    {
    }
