...
public class crafting_blaster_pistol_barrel_component extends script.systems.crafting.weapon.crafting_base_weapon_component
{
    public crafting_blaster_pistol_barrel_component()
    {
    }
