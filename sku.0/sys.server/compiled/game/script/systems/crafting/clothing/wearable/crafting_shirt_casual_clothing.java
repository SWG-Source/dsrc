...
public class crafting_shirt_casual_clothing extends script.systems.crafting.clothing.crafting_base_clothing
{
    public crafting_shirt_casual_clothing()
    {
    }
    ...
    {
        "object/tangible/wearables/shirt/shared_shirt_s03.iff",
    ...
    public draft_schematic.custom[] getCustomizations(obj_id player, draft_schematic.custom[] customizations) throws InterruptedException
    {
        ...
        else if (customizations.length > 1 && playerCustomizationMod < 201)
        {
