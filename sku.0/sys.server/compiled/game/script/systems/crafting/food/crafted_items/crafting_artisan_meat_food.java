...
public class crafting_artisan_meat_food extends script.systems.crafting.food.crafting_base_food
{
    public crafting_artisan_meat_food()
    {
    }
    ...
    {
        new resource_weight("energy", new resource_weight.weight[]
        {
        ...
        new resource_weight("filling", new resource_weight.weight[]
        {
            ...
            new resource_weight.weight(craftinglib.RESOURCE_POTENTIAL_ENERGY, 1),
            new resource_weight.weight(craftinglib.RESOURCE_TOUGHNESS, 1),
            new resource_weight.weight(craftinglib.RESOURCE_VOLUME, 1)
        }),
    ...
    public static final resource_weight[] OBJ_MAX_ATTRIBUTE_RESOURCES = 
    {
        ...
        new resource_weight("filling", new resource_weight.weight[]
        {
            ...
            new resource_weight.weight(craftinglib.RESOURCE_POTENTIAL_ENERGY, 1),
            new resource_weight.weight(craftinglib.RESOURCE_TOUGHNESS, 1),
            new resource_weight.weight(craftinglib.RESOURCE_VOLUME, 4)
        }),
        new resource_weight("decayRate", new resource_weight.weight[]
        {
            new resource_weight.weight(craftinglib.RESOURCE_CONDUCTIVITY, 1),
