...
public class crafting_creature_eopie extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_eopie()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_eopie";
