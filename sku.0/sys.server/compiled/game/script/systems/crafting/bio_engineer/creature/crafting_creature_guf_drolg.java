...
public class crafting_creature_guf_drolg extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_guf_drolg()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_guf_drolg";
