...
public class crafting_creature_vesp extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_vesp()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_vesp";
