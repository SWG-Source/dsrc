...
public class crafting_creature_vir_vur extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_vir_vur()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_vir_vur";
