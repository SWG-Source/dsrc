...
public class crafting_creature_huf_dun extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_huf_dun()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_huf_dun";
