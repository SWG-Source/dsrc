...
public class crafting_creature_bolle_bol extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_bolle_bol()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_bolle_bol";
