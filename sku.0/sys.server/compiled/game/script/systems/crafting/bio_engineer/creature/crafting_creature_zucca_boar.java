...
public class crafting_creature_zucca_boar extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_zucca_boar()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_zucca_boar";
