...
public class crafting_creature_gurrcat extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_gurrcat()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_tusk_cat";
