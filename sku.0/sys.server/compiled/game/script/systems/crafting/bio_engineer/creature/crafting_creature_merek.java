...
public class crafting_creature_merek extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_merek()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_merek";
