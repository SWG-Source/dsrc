package script.systems.crafting.bio_engineer.utilities;
...
public class crafting_pet_vitapack extends script.systems.crafting.bio_engineer.crafting_base_pet_meds
{
    public crafting_pet_vitapack()
    {
    }
    ...
    {
        new resource_weight("strength", new resource_weight.weight[]
        {
