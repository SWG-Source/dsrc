...
public class crafting_creature_ikopi extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_ikopi()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_ikopi";
