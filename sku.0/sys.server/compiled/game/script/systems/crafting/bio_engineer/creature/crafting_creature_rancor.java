...
public class crafting_creature_rancor extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_rancor()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_rancor";
