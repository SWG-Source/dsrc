...
public class crafting_creature_sand_panther extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_sand_panther()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_sand_panther";
