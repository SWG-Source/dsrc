...
public class crafting_creature_dune_lizard extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_dune_lizard()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_dune_lizard";
