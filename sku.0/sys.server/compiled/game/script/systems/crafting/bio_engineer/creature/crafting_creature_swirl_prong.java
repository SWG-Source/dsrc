...
public class crafting_creature_swirl_prong extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_swirl_prong()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_swirl_prong";
