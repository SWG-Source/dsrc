...
public class crafting_creature_carrion_spat extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_carrion_spat()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_carrion_spat";
