...
public class crafting_creature_shear_mite extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_shear_mite()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_shear_mite";
