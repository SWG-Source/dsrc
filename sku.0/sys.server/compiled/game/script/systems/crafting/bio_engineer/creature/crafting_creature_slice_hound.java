...
public class crafting_creature_slice_hound extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_slice_hound()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_slice_hound";
