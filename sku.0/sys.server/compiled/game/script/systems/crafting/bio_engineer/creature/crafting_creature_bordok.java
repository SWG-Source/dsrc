...
public class crafting_creature_bordok extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_bordok()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_bordok";
