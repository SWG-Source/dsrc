...
public class crafting_creature_gurnaset extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_gurnaset()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_gurnaset";
