...
public class crafting_creature_mott extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_mott()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_mott";
