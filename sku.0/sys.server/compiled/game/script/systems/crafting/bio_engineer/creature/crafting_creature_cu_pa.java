...
public class crafting_creature_cu_pa extends script.systems.crafting.bio_engineer.crafting_base_creature
{
    public crafting_creature_cu_pa()
    {
    }
    ...
    public static final String CREATURE_NAME = "bio_engineered_cu_pa";
