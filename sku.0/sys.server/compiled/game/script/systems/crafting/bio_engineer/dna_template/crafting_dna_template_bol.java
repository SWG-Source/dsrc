...
public class crafting_dna_template_bol extends script.systems.crafting.bio_engineer.crafting_base_dna_template
{
    public crafting_dna_template_bol()
    {
    }
    ...
    {
        "object/tangible/component/dna/dna_template_bol.iff"
    };
