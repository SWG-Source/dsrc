...
public class shields_analysis_tool extends script.base_script
{
    ...
    public int OnAboutToReceiveItem(obj_id self, obj_id srcContainer, obj_id transferer, obj_id item) throws InterruptedException
    {
        ...
        if (space_crafting.getShipComponentStringType(item) != "shield")
        {
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        if (item == menu_info_types.SERVER_MENU1)
        {
            ...
            {
                if (space_crafting.getShipComponentStringType(x[i]) != "shield")
                {
                    string_id errormessage2 = new string_id(TOOL, "wrong_component_type");
    ...
    public obj_id createImprovedLoot(obj_id player, String template) throws InterruptedException
    {
        ...
        float fltShieldHitpointsMaximumFrontModifier = dataTableGetFloat(TABLE, template, "fltShieldHitpointsMaximumFrontModifier");
        float fltShieldHitpointsMaximumFront = dataTableGetFloat(TABLE, template, "fltShieldHitpointsMaximumFront");
        fltShieldHitpointsMaximumFront = fltShieldHitpointsMaximumFront + fltShieldHitpointsMaximumFrontModifier;
        float fltShieldHitpointsMaximumBackModifier = dataTableGetFloat(TABLE, template, "fltShieldHitpointsMaximumBackModifier");
        float fltShieldHitpointsMaximumBack = dataTableGetFloat(TABLE, template, "fltShieldHitpointsMaximumBack");
        fltShieldHitpointsMaximumBack = fltShieldHitpointsMaximumBack + fltShieldHitpointsMaximumBackModifier;
        space_crafting.setShieldGeneratorMaximumFrontHitpoints(newWeapon, fltShieldHitpointsMaximumFront);
        space_crafting.setShieldGeneratorMaximumBackHitpoints(newWeapon, fltShieldHitpointsMaximumBack);
    ...
    public obj_id createSpecialLoot(obj_id player, String template) throws InterruptedException
    {
        ...
        float fltShieldHitpointsMaximumFront = dataTableGetFloat(TABLE, template, "fltShieldHitpointsMaximumFront");
        fltShieldHitpointsMaximumFront = fltShieldHitpointsMaximumFront + fltShieldHitpointsMaximumFrontModifier;
        fltShieldHitpointsMaximumFront = fltShieldHitpointsMaximumFront + ((.05f) * fltShieldHitpointsMaximumFront);
        float fltShieldHitpointsMaximumBackModifier = dataTableGetFloat(TABLE, template, "fltShieldHitpointsMaximumBackModifier");
        float fltShieldHitpointsMaximumBack = dataTableGetFloat(TABLE, template, "fltShieldHitpointsMaximumBack");
        fltShieldHitpointsMaximumBack = fltShieldHitpointsMaximumBack + fltShieldHitpointsMaximumBackModifier;
        fltShieldHitpointsMaximumBack = fltShieldHitpointsMaximumBack + ((.05f) * fltShieldHitpointsMaximumBack);
        space_crafting.setShieldGeneratorMaximumFrontHitpoints(newWeapon, fltShieldHitpointsMaximumFront);
        space_crafting.setShieldGeneratorMaximumBackHitpoints(newWeapon, fltShieldHitpointsMaximumBack);
        setObjVar(newWeapon, "cannotReverseEngineer", true);
        return newWeapon;
