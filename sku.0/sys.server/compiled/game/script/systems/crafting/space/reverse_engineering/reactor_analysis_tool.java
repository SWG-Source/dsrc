...
public class reactor_analysis_tool extends script.base_script
{
    ...
    public static final String TABLE = "datatables/ship/components/reactor.iff";
    ...
    public int OnAboutToReceiveItem(obj_id self, obj_id srcContainer, obj_id transferer, obj_id item) throws InterruptedException
    {
        ...
        if (space_crafting.getShipComponentStringType(item) != "reactor")
        {
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        if (item == menu_info_types.SERVER_MENU1)
        {
            ...
            for (obj_id x2 : x) {
                if (space_crafting.getShipComponentStringType(x2) != "reactor") {
                    string_id errormessage2 = new string_id(TOOL, "wrong_component_type");
    ...
    public obj_id createImprovedLoot(obj_id player, String template) throws InterruptedException
    {
        ...
        float fltEnergyGenerationModifier = dataTableGetFloat(TABLE, template, "fltEnergyGenerationModifier");
        float fltEnergyGeneration = dataTableGetFloat(TABLE, template, "fltEnergyGeneration");
        fltEnergyGeneration = fltEnergyGeneration + fltEnergyGenerationModifier;
        space_crafting.setReactorEnergyGeneration(newWeapon, fltEnergyGeneration);
        return newWeapon;
    }
    public obj_id createSpecialLoot(obj_id player, String template) throws InterruptedException
    {
        ...
        float fltEnergyGeneration = dataTableGetFloat(TABLE, template, "fltEnergyGeneration");
        fltEnergyGeneration = fltEnergyGeneration + fltEnergyGenerationModifier;
        fltEnergyGeneration = fltEnergyGeneration + ((0.05f) * fltEnergyGeneration);
        space_crafting.setReactorEnergyGeneration(newWeapon, fltEnergyGeneration);
        return newWeapon;
    }
}
