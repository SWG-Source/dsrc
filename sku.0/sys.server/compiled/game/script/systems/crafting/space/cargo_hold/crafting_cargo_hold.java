...
public class crafting_cargo_hold extends script.systems.crafting.space.cargo_hold.crafting_base_cargo_hold
{
    public crafting_cargo_hold()
    {
    }
    ...
    public static final resource_weight[] OBJ_ASSEMBLY_ATTRIBUTE_RESOURCES = 
    {
        ...
        new resource_weight("maxCapacity", new resource_weight.weight[]
        {
            new resource_weight.weight(craftinglib.RESOURCE_TOUGHNESS, 1),
            new resource_weight.weight(craftinglib.RESOURCE_QUALITY, 1)
        })
