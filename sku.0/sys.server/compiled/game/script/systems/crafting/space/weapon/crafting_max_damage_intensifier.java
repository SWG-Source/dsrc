...
public class crafting_max_damage_intensifier extends script.systems.crafting.space.weapon.crafting_base_space_weapon_component
{
    public crafting_max_damage_intensifier()
    {
    }
