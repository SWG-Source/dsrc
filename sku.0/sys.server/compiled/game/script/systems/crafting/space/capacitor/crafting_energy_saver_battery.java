...
public class crafting_energy_saver_battery extends script.systems.crafting.space.capacitor.crafting_base_capacitor_component
{
    public crafting_energy_saver_battery()
    {
    }
