...
public class crafting_tiedefender_chassis extends script.systems.crafting.space.chassis.crafting_base_tiedefender_chassis
{
    public crafting_tiedefender_chassis()
    {
    }
