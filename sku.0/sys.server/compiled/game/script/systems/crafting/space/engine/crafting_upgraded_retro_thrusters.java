...
public class crafting_upgraded_retro_thrusters extends script.systems.crafting.space.engine.crafting_base_engine_component
{
    public crafting_upgraded_retro_thrusters()
    {
    }
