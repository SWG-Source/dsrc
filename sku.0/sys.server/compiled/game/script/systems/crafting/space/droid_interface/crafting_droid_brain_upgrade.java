...
public class crafting_droid_brain_upgrade extends script.systems.crafting.space.droid_interface.crafting_base_droid_interface_component
{
    public crafting_droid_brain_upgrade()
    {
    }
