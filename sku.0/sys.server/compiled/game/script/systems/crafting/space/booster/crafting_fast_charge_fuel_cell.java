...
public class crafting_fast_charge_fuel_cell extends script.systems.crafting.space.booster.crafting_base_booster_component
{
    public crafting_fast_charge_fuel_cell()
    {
    }
