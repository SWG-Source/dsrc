...
public class crafting_base_blacksun_light_s03_chassis extends script.systems.crafting.crafting_base
{
    public crafting_base_blacksun_light_s03_chassis()
    {
    }
    ...
    public void calcAndSetPrototypeProperties(obj_id prototype, draft_schematic.attribute[] itemAttributes) throws InterruptedException
    {
        ...
        for (int i = 0; i < itemAttributes.length; ++i)
        {
            ...
            setObjVar(prototype, "shiptype", "blacksun_light_s03");
