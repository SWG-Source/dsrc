...
public class crafting_decimator_chassis extends script.systems.crafting.space.chassis.crafting_base_decimator_chassis
{
    public crafting_decimator_chassis()
    {
    }
