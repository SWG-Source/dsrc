...
public class crafting_8d8_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_8d8_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "droid_8d8_crafted";
