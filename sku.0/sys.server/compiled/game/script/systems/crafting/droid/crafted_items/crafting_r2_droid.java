...
public class crafting_r2_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_r2_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "r2_crafted";
