...
public class crafting_r4_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_r4_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "r4_crafted";
