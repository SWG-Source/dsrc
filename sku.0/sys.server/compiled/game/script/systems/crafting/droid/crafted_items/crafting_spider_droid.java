...
public class crafting_spider_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_spider_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "spider_droid";
