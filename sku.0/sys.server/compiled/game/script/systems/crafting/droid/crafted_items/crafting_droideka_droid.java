...
public class crafting_droideka_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_droideka_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "droideka";
