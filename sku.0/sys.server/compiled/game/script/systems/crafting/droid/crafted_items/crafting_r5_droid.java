...
public class crafting_r5_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_r5_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "r5_crafted";
