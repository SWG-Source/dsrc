...
public class crafting_super_battle_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_super_battle_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "super_battle_droid_crafted";
