...
public class crafting_asn_171_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_asn_171_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "asn_121_crafted";
