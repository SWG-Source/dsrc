...
public class crafting_binary_load_lifter_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_binary_load_lifter_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "cll8_binary_load_lifter";
