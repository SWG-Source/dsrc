...
public class crafting_mse_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_mse_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "mouse_droid_crafted";
