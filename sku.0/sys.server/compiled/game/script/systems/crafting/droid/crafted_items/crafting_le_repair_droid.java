...
public class crafting_le_repair_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_le_repair_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "le_repair_droid";
