...
public class crafting_battle_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_battle_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "battle_droid_crafted";
