...
public class crafting_lin_demolition_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_lin_demolition_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "lin_demolitionmech_crafted";
