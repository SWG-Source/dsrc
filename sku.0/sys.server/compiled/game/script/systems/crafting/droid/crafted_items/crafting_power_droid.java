...
public class crafting_power_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_power_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "eg6_power_droid_crafted";
