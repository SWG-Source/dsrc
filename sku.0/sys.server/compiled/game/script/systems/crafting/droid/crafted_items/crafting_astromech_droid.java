...
public class crafting_astromech_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_astromech_droid()
    {
    }
    ...
    public draft_schematic.custom[] getCustomizations(obj_id player, draft_schematic.custom[] customizations) throws InterruptedException
    {
        ...
        if (playerCustomizationMod > 63)
        {
            playerCustomizationMod = 63;
        }
        for (int i = 0; i < customizations.length; ++i)
        {
            customizations[i].maxValue = (int)(playerCustomizationMod);
        }
        if (customizations.length > 0 && playerCustomizationMod < 32)
        {
