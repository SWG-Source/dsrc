...
public class crafting_probot_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_probot_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "probot";
