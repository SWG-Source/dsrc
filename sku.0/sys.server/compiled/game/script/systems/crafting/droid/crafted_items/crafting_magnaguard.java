...
public class crafting_magnaguard extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_magnaguard()
    {
    }
    ...
    public static final String CREATURE_NAME = "magnaguard_crafted";
