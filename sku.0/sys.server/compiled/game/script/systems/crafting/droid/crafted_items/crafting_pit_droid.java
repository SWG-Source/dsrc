...
public class crafting_pit_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_pit_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "pit_droid_crafted";
