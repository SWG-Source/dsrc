...
public class crafting_3p0_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_3p0_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "protocol_droid_3po_crafted";
