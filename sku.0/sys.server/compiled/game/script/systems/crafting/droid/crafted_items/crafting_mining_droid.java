...
public class crafting_mining_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_mining_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "mining_droid_crafted";
    ...
    public draft_schematic.custom[] getCustomizations(obj_id player, draft_schematic.custom[] customizations) throws InterruptedException
    {
        ...
        {
            if ((customizations[i].maxValue - customizations[i].minValue) < 3)
            {
