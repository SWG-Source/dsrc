...
public class crafting_mark_iv_sentry_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_mark_iv_sentry_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "mark_iv_sentry_droid_crafted";
