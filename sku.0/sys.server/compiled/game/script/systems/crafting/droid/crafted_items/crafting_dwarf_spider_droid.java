...
public class crafting_dwarf_spider_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_dwarf_spider_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "dwarf_spider_droid_crafted";
