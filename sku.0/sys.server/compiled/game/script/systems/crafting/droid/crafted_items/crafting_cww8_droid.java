...
public class crafting_cww8_droid extends script.systems.crafting.droid.crafting_base_droid
{
    public crafting_cww8_droid()
    {
    }
    ...
    public static final String CREATURE_NAME = "cww8_droid_crafted";
