...
public class crafting_ballot_terminal extends script.systems.crafting.item.crafting_base_ballot_terminal
{
    public crafting_ballot_terminal()
    {
    }
    ...
    {
        "craft_general_assembly"
    };
    public static final String[] EXPERIMENT_SKILL_MODS = 
    {
        "craft_general_experimentation"
    };
