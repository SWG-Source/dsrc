...
public class crafting_enhance_health_triad_chemical extends script.systems.crafting.crafting_base
{
    public crafting_enhance_health_triad_chemical()
    {
    }
    ...
    public void calcAndSetPrototypeProperties(obj_id prototype, draft_schematic.attribute[] itemAttributes) throws InterruptedException
    {
        ...
        int duration = rand(300, 600);
        attrib_mod[] am = new attrib_mod[3];
        am[0] = new attrib_mod(0, tempPower, tempDuration, healing.VAR_BUFF_MOD_ATTACK, healing.VAR_BUFF_MOD_DECAY);
        am[1] = new attrib_mod(1, tempPower, tempDuration, healing.VAR_BUFF_MOD_ATTACK, healing.VAR_BUFF_MOD_DECAY);
        am[2] = new attrib_mod(2, tempPower, tempDuration, healing.VAR_BUFF_MOD_ATTACK, healing.VAR_BUFF_MOD_DECAY);
