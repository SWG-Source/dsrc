...
public class crafting_struct_enzyme_processor extends script.systems.crafting.chemistry.enzyme.crafting_base_enzyme_processing
{
    public crafting_struct_enzyme_processor()
    {
    }
