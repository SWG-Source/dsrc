...
public class crafting_component_chemistry_basic_medic extends script.systems.crafting.chemistry.crafting_base_chemical_component
{
    public crafting_component_chemistry_basic_medic()
    {
    }
