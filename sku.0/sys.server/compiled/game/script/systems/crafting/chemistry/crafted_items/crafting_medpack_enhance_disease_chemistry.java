...
public class crafting_medpack_enhance_disease_chemistry extends script.systems.crafting.chemistry.crafting_enhance_disease_chemical
{
    public crafting_medpack_enhance_disease_chemistry()
    {
    }
    ...
    public static final resource_weight[] OBJ_ASSEMBLY_ATTRIBUTE_RESOURCES = 
    {
        ...
        new resource_weight("absorption", new resource_weight.weight[]
        {
            new resource_weight.weight(craftinglib.RESOURCE_POTENTIAL_ENERGY, 2),
            new resource_weight.weight(craftinglib.RESOURCE_QUALITY, 4)
        }),
