...
public class crafting_new_armor_factional_final extends script.systems.crafting.armor.crafting_new_armor_final
{
    public crafting_new_armor_factional_final()
    {
    }
