...
public class treasure_guard extends script.base_script
{
    ...
    public int OnCreatureDamaged(obj_id self, obj_id attacker, obj_id weapon, int[] damage) throws InterruptedException
    {
        ...
        {
            CustomerServiceLog("treasureMap", "Mob: " + self + " " + getName(self) + " is NOT ATTACKABLE to: " + attacker + " Mob location: " + getLocation(self) + ". [ OnCreatureDamaged() ]");
        }
        if (getBehavior(self) != BEHAVIOR_CALM && getBehavior(self) != BEHAVIOR_ATTACK)
        {
            CustomerServiceLog("treasureMap", "Mob: " + self + " " + getName(self) + " is being attacked by: " + attacker + " at location: " + getLocation(self) + " with a behavior int: " + getBehavior(self) + ". [ OnCreatureDamaged() ]");
        }
