...
public class theater_spawn2_5 extends script.base_script
{
    public theater_spawn2_5()
    {
    }
    public int OnTheaterCreated(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        quests.createSpawner("fs_quest_sad_2_5_1", mylocation, "datatables/quest/force_sensitive/base_spawn.iff", player);
