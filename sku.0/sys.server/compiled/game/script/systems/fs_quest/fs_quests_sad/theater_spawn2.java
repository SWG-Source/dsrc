...
public class theater_spawn2 extends script.base_script
{
    public theater_spawn2()
    {
    }
    public int OnTheaterCreated(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        quests.createSpawner("fs_quest_sad2_1", mylocation, "datatables/quest/force_sensitive/base_spawn.iff", player);
