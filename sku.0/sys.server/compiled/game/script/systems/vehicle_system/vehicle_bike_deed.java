...
public class vehicle_bike_deed extends script.base_script
{
    ...
    public obj_id createCraftedCreatureDevice(obj_id player, obj_id deed) throws InterruptedException
    {
        ...
        String controlTemplate = "object/intangible/vehicle/speederbike_pcd.iff";
        ...
        else 
        {
            ...
            setObjVar(petControlDevice, "vehicle.template", "speederbike");
        ...
        obj_id pet = create.object("object/mobile/vehicle/speederbike.iff", getLocation(player));
        if (!isIdValid(pet))
        {
