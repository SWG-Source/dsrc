...
public class hall_wave_02 extends script.base_script
{
    public hall_wave_02()
    {
    }
    ...
    public int OnCreatureDamaged(obj_id self, obj_id attacker, obj_id wpn, int[] damage) throws InterruptedException
    {
        if (!hasObjVar(self, "death_watch.call_backup"))
        {
            ...
            messageTo(hallTerminal, "handleCallSupport2", null, 30.0f, false);
        }
        return SCRIPT_CONTINUE;
    }
    public int handleInvestigate(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        location attack = new location(-88.5f, 0, -37.5f, planet, room);
