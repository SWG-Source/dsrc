...
public class herald_boss extends script.base_script
{
    ...
    public int SpawnBoss(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        location backup01Location = new location(114.10f, -64.0f, -89.08f, "endor", getCellId(building, "smallroom35"));
        ...
        location backup02Location = new location(116.29f, -64.0f, -100.58f, "endor", getCellId(building, "smallroom35"));
        ...
        location backup03Location = new location(117.02f, -64.0f, -106.03f, "endor", getCellId(building, "smallroom35"));
        ...
        location backup04Location = new location(112.46f, -64.0f, -104.34f, "endor", getCellId(building, "smallroom35"));
