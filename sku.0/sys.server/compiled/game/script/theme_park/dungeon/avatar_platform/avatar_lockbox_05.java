...
public class avatar_lockbox_05 extends script.base_script
{
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        {
            if (groundquests.isQuestActive(player, "ep3_avatar_wke_prisoner_05"))
            {
            ...
            else if (groundquests.hasCompletedQuest(player, "ep3_avatar_wke_prisoner_05"))
            {
    ...
    {
        money.bankTo(money.ACCT_NEW_PLAYER_QUESTS, player, 25000);
        groundquests.sendSignal(player, "lockBox05");
        createObjectInInventoryAllowOverload("object/tangible/loot/loot_schematic/trandoshan_hunter_rifle_schematic.iff", player);
    }
}
