...
public class avatar_lockbox_02 extends script.base_script
{
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        {
            if (groundquests.isQuestActive(player, "ep3_avatar_wke_prisoner_02"))
            {
            ...
            else if (groundquests.hasCompletedQuest(player, "ep3_avatar_wke_prisoner_02"))
            {
    ...
    public void grantReward(obj_id player) throws InterruptedException
    {
        ...
        money.bankTo(money.ACCT_NEW_PLAYER_QUESTS, player, 1000);
        groundquests.sendSignal(player, "lockBox02");
        weapons.createWeapon("object/weapon/ranged/carbine/ep3/carbine_wookiee_bowcaster.iff", playerInv, 1, 1, 1, 1);
    }
}
