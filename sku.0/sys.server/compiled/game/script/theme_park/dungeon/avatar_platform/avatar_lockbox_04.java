...
public class avatar_lockbox_04 extends script.base_script
{
    public avatar_lockbox_04()
    {
    }
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        {
            if (groundquests.isQuestActive(player, "ep3_avatar_wke_prisoner_04"))
            {
            ...
            else if (groundquests.hasCompletedQuest(player, "ep3_avatar_wke_prisoner_04"))
            {
    ...
    public void grantReward(obj_id player) throws InterruptedException
    {
        ...
        money.bankTo(money.ACCT_NEW_PLAYER_QUESTS, player, 2000);
        groundquests.sendSignal(player, "lockBox04");
        weapons.createWeapon("object/weapon/ranged/pistol/ep3/pistol_ion_stunner.iff", playerInv, 1, 1, 1, 1);
        return;
    }
}
