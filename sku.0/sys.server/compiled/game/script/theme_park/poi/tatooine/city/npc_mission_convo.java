...
public class npc_mission_convo extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int OnNpcConversationResponse(obj_id self, String convo, obj_id player, string_id response) throws InterruptedException
    {
        ...
        if ((response.getAsciiId()).equals("npc_msn_0" + convoNum + "_presp_greeting_01"))
        {
        ...
        if ((response.getAsciiId()).equals("npc_msn_0" + convoNum + "_presp_greeting_02"))
        {
    ...
    public void scriptDetacher(obj_id self) throws InterruptedException
    {
