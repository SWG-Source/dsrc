...
public class poi_stormtrooper_outpost4 extends script.theme_park.poi.base
{
    public poi_stormtrooper_outpost4()
    {
    }
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        {
            obj_id outpost = poiCreateObject(self, "center", "object/installation/turret/turret_dish_large.iff", 0, 0);
