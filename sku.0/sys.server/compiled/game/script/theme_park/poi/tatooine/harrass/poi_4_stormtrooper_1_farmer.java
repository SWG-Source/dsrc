...
public class poi_4_stormtrooper_1_farmer extends script.theme_park.poi.base
{
    public poi_4_stormtrooper_1_farmer()
    {
    }
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        obj_id tr3 = poiCreateNpc("stormtrooper", 10, 6);
        obj_id tr4 = poiCreateNpc("stormtrooper", 9, 7);
        ...
        messageTo(tr3, "killTarget", farmerObj, 60, true);
        messageTo(tr4, "killTarget", farmerObj, 60, true);
        messageTo(tr1, "doFacing", farmerObj, 3, true);
        messageTo(tr2, "doFacing", farmerObj, 3, true);
        messageTo(tr3, "doFacing", farmerObj, 3, true);
        messageTo(tr4, "doFacing", farmerObj, 3, true);
