...
public class poi_stormtrooper_outpost2 extends script.theme_park.poi.base
{
    public poi_stormtrooper_outpost2()
    {
    }
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        {
            obj_id outpost = poiCreateObject(self, "center", "object/installation/turret/turret_block_med.iff", 0, 0);
