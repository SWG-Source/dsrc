...
public class npc_mission_02_convo extends script.systems.missions.base.mission_dynamic_base
{
    public npc_mission_02_convo()
    {
    }
    public static final String CONVO = "npc_mission/npc_mission_02";
    ...
    public int OnStartNpcConversation(obj_id self, obj_id speaker) throws InterruptedException
    {
        ...
        string_id greeting = new string_id(CONVO, "npc_msn_02_greeting_01");
        string_id response[] = new string_id[2];
        response[0] = new string_id(CONVO, "npc_msn_02_presp_greeting_01");
        response[1] = new string_id(CONVO, "npc_msn_02_presp_greeting_02");
        npcStartConversation(speaker, self, "missionConvo", greeting, response);
        return SCRIPT_CONTINUE;
    }
    public int OnNpcConversationResponse(obj_id self, String convo, obj_id player, string_id response) throws InterruptedException
    {
        if ((response.getAsciiId()).equals("npc_msn_02_presp_greeting_01"))
        {
            string_id message = new string_id(CONVO, "npc_msn_02_work_01");
            npcSpeak(player, message);
            npcRemoveConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_greeting_01"));
            npcRemoveConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_greeting_02"));
            npcAddConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_getmission_03"));
            npcAddConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_getmission_04"));
            return SCRIPT_CONTINUE;
        }
        if ((response.getAsciiId()).equals("npc_msn_02_presp_greeting_02"))
        {
            string_id message = new string_id(CONVO, "npc_msn_02_busy_01");
            npcSpeak(player, message);
            npcRemoveConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_greeting_01"));
            npcRemoveConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_greeting_02"));
            npcAddConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_getmission_05"));
            return SCRIPT_CONTINUE;
        }
        ...
        {
            string_id message = new string_id(CONVO, "npc_msn_02_work_02");
            npcSpeak(player, message);
            npcRemoveConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_getmission_03"));
            npcRemoveConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_getmission_04"));
            npcAddConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_getmission_01"));
            npcAddConversationResponse(player, new string_id(CONVO, "npc_msn_02_presp_getmission_02"));
            return SCRIPT_CONTINUE;
        }
        if ((response.getAsciiId()).equals("npc_msn_02_presp_getmission_01") || (response.getAsciiId()).equals("npc_msn_02_presp_getmission_02"))
        {
            ...
            if (objMission != null)
            {
                string_id strResponse = new string_id(CONVO, "npc_msn_02_greeting_onmission");
