...
public class mos_taike_guard_old extends script.base_script
{
    public mos_taike_guard_old()
    {
    }
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        obj_id hair = createObject("object/tangible/hair/human/hair_human_male_s23.iff", self, "");
        setName(self, "Lorne Prestar");
        ...
        attachScript(self, "theme_park.tatooine.mos_taike.old_guard_destroy");
        debugSpeakMsg(self, "Git off mah lawn you kids!");
