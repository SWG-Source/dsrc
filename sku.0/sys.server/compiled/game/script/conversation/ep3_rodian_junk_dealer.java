...
public class ep3_rodian_junk_dealer extends script.base_script
{
    ...
    public boolean ep3_rodian_junk_dealer_condition_check_inv(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean ep3_rodian_junk_dealer_condition_cannotSpeakWookiee(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void ep3_rodian_junk_dealer_action_vocalizeMed(obj_id player, obj_id npc) throws InterruptedException
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_4sec.cef", player, "");
    }
