...
public class ep3_etyyy_pilot_bocctyyy_to_etyyy extends script.base_script
{
    ...
    public void ep3_etyyy_pilot_bocctyyy_to_etyyy_action_ejectPlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        space_dungeon.ejectPlayerFromDungeon(player);
        return;
    }
    public int ep3_etyyy_pilot_bocctyyy_to_etyyy_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("ep3_etyyy_pilot_bocctyyy_to_etyyy"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
