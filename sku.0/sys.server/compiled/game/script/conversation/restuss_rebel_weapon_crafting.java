...
public class restuss_rebel_weapon_crafting extends script.base_script
{
    public restuss_rebel_weapon_crafting()
    {
    }
    public static String c_stringFile = "conversation/restuss_rebel_weapon_crafting";
    public boolean restuss_rebel_weapon_crafting_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean restuss_rebel_weapon_crafting_condition_completedCrafting1(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "restuss_rebel_carbine_crafting_1", "returnIngri");
    }
    public boolean restuss_rebel_weapon_crafting_condition_craftingActive1(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "restuss_rebel_carbine_crafting_1");
    }
    public boolean restuss_rebel_weapon_crafting_condition_completedCrafting2(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "restuss_rebel_carbine_crafting_2", "returnIngri2");
    }
    public boolean restuss_rebel_weapon_crafting_condition_craftingActive2(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "restuss_rebel_carbine_crafting_2");
    }
    public boolean restuss_rebel_weapon_crafting_condition_inPhase2(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean restuss_rebel_weapon_crafting_condition_inPhase1(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean restuss_rebel_weapon_crafting_condition_enoughWeapons(obj_id player, obj_id npc) throws InterruptedException
    {
        obj_id object = trial.getParent(npc);
    ...
    public boolean restuss_rebel_weapon_crafting_condition_isImperialPlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        return factions.isImperial(player);
    }
    public void restuss_rebel_weapon_crafting_action_giveCrafting1(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "restuss_rebel_carbine_crafting_1");
    }
    public void restuss_rebel_weapon_crafting_action_signalDone(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void restuss_rebel_weapon_crafting_action_giveCrafting2(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "restuss_rebel_carbine_crafting_2");
    }
    public void restuss_rebel_weapon_crafting_action_signalDone2(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void restuss_rebel_weapon_crafting_action_eject(obj_id player, obj_id npc) throws InterruptedException
    {
        expelFromBuilding(player);
    }
    public int restuss_rebel_weapon_crafting_handleBranch6(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int restuss_rebel_weapon_crafting_handleBranch9(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int restuss_rebel_weapon_crafting_handleBranch12(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("restuss_rebel_weapon_crafting"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
