...
public class rodian_apprentice_hunter extends script.base_script
{
    ...
    public int rodian_apprentice_hunter_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_5dd91854"))
        {
    ...
    {
        if (!conversationId.equals("rodian_apprentice_hunter"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
