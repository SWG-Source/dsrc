...
public class c_story1_4_imp_guard extends script.base_script
{
    public c_story1_4_imp_guard()
    {
    }
    public static String c_stringFile = "conversation/c_story1_4_imp_guard";
    public boolean c_story1_4_imp_guard_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean c_story1_4_imp_guard_condition_onQuestBeforeAttack(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean c_story1_4_imp_guard_condition_onQuestAfterAttack(obj_id player, obj_id npc) throws InterruptedException
    {
        int questId1 = questGetQuestId("quest/c_story1_4b_imperial");
        int imp_headguard2 = groundquests.getTaskId(questId1, "imp_headguard2");
        return questIsTaskActive(questId1, imp_headguard2, player);
    }
    public boolean c_story1_4_imp_guard_condition_doneWithGuard(obj_id player, obj_id npc) throws InterruptedException
    {
        int questId1 = questGetQuestId("quest/c_story1_4b_imperial");
        int imp_headguard2 = groundquests.getTaskId(questId1, "imp_headguard2");
        return questIsTaskComplete(questId1, imp_headguard2, player);
    }
    public void c_story1_4_imp_guard_action_facePlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
    }
    public void c_story1_4_imp_guard_action_signalStartAttack(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "c_story1_4b_imperial_guard1");
    }
    public void c_story1_4_imp_guard_action_signalGuardDone(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "c_story1_4b_imperial_guard2");
    }
    public int c_story1_4_imp_guard_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int c_story1_4_imp_guard_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int c_story1_4_imp_guard_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int c_story1_4_imp_guard_handleBranch5(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int c_story1_4_imp_guard_handleBranch6(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int c_story1_4_imp_guard_handleBranch8(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_26"))
        {
            if (c_story1_4_imp_guard_condition__defaultCondition(player, npc))
    ...
    {
        if (!conversationId.equals("c_story1_4_imp_guard"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
