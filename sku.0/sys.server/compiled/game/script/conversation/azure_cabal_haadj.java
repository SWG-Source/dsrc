...
public class azure_cabal_haadj extends script.conversation.base.conversation_base
{
    ...
    private boolean azure_cabal_haadj_condition_onAssignment_30ENF_Q1C(obj_id player) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "ac_repeater_loruna_enf_30_dnpc1_haadj_01", "ac_30_haadj_01_dml1");
    }
    private boolean azure_cabal_haadj_condition_onAssignment_30ENF_Q1D(obj_id player) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "ac_repeater_loruna_enf_30_dnpc1_haadj_01", "ac_30_haadj_01_dml2");
    }
    private boolean azure_cabal_haadj_condition_onTask_30ENF_Q1_Return(obj_id player) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "ac_repeater_loruna_enf_30_dnpc1_haadj_01", "ac_30_haadj_01_wfs_quest_complete");
    }
    public boolean azure_cabal_haadj_condition_onTask_30ENF_Repeater_Q1orQ2(obj_id player) throws InterruptedException
    {
    ...
    private boolean azure_cabal_haadj_condition_onQuest_30ENF_Q1(obj_id player) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "ac_repeater_loruna_enf_30_dnpc1_haadj_01");
    }
    private boolean azure_cabal_haadj_condition_onAssignment_30ENF_Q2A(obj_id player) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "ac_repeater_loruna_enf_30_dnpc1_haadj_02", "ac_30_haadj_02_dm1");
    }
    private boolean azure_cabal_haadj_condition_onAssignment_30ENF_Q2B(obj_id player) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "ac_repeater_loruna_enf_30_dnpc1_haadj_02", "ac_30_haadj_02_dm2");
    }
    private boolean azure_cabal_haadj_condition_onAssignment_30ENF_Q2C(obj_id player) throws InterruptedException
    {
    ...
    private boolean azure_cabal_haadj_condition_onAssignment_30ENF_Q2D(obj_id player) throws InterruptedException
    {
    ...
    private boolean azure_cabal_haadj_condition_onAssignment_30ENF_Q1A(obj_id player) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "ac_repeater_loruna_enf_30_dnpc1_haadj_01", "ac_30_haadj_01_dm1");
    }
    private boolean azure_cabal_haadj_condition_onTask_30ENF_Q2_Return(obj_id player) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "ac_repeater_loruna_enf_30_dnpc1_haadj_02", "ac_30_haadj_02_wfs_quest_complete");
    }
    private boolean azure_cabal_haadj_condition_onQuest_30ENF_Q2(obj_id player) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "ac_repeater_loruna_enf_30_dnpc1_haadj_02");
    }
    private boolean azure_cabal_haadj_condition_onTask_30ENF_Repeater_Q1(obj_id player) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "ac_repeater_loruna_enf_30", "ac_repeater_loruna_enf_30_WFS_haadj_01");
    }
    private boolean azure_cabal_haadj_condition_onTask_30ENF_Repeater_Q2(obj_id player) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "ac_repeater_loruna_enf_30", "ac_repeater_loruna_enf_30_WFS_haadj_02");
    }
    public boolean azure_cabal_haadj_condition_onQuest_30ENF_Q1orQ2(obj_id player) throws InterruptedException
    {
    ...
    private void azure_cabal_haadj_action_grant30Q1(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
        groundquests.grantQuest(player, "quest/ac_repeater_loruna_enf_30_dnpc1_haadj_01");
    }
    private void azure_cabal_haadj_action_signal_30ENF_ClearRepeaterQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
    ...
    private void azure_cabal_haadj_action_grant30Q2(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
        groundquests.grantQuest(player, "quest/ac_repeater_loruna_enf_30_dnpc1_haadj_02");
    }
    private void azure_cabal_haadj_action_signal_30ENF_CompleteQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "ac_quest_complete");
    }
    public String azure_cabal_haadj_tokenTO_playerFirstName(obj_id player) throws InterruptedException
    {
        return getFirstName(player);
    }
    public String azure_cabal_haadj_tokenTO_playersProfession() throws InterruptedException
    {
        return "";
    }
    private int azure_cabal_haadj_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    private int azure_cabal_haadj_handleBranch12(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q1A(player))
            {
                return craft_response(new String[] {"s_197", "s_216", "s_217"}, 13, player);
            }
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q1B(player))
            {
                return craft_response(new String[] {"s_199", "s_239", "s_240"}, 20, player);
            }
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q1C(player))
            {
                return craft_response(new String[] {"s_201", "s_108", "s_109"}, 26, player);
            }
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q1D(player))
            {
    ...
    private int azure_cabal_haadj_handleBranch38(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            utils.removeScriptVar(player, conversation + ".branchId");
            npcEndConversationWithMessage(player, new string_id(c_stringFile, "s_137"));
            return SCRIPT_CONTINUE;
        }
        else if (response.equals("s_139"))
        {
    ...
    private int azure_cabal_haadj_handleBranch40(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_136", "s_140", "s_162"}, 41, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch41(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_142", "s_144", "s_160"}, 42, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch42(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_146", "s_148", "s_158"}, 43, player);
        }
        else if (response.equals("s_160"))
        {
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q1A(player))
            {
                return craft_response(new String[] {"s_197", "s_216", "s_217"}, 13, player);
    ...
    private int azure_cabal_haadj_handleBranch43(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_150", "s_152", "s_156"}, 44, player);
        }
        else if (response.equals("s_158"))
        {
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q1A(player))
            {
                return craft_response(new String[] {"s_197", "s_216", "s_217"}, 13, player);
    ...
    private int azure_cabal_haadj_handleBranch44(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            utils.removeScriptVar(player, conversation + ".branchId");
            npcEndConversationWithMessage(player, new string_id(c_stringFile, "s_154"));
            return SCRIPT_CONTINUE;
        }
        else if (response.equals("s_156"))
        {
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q1A(player))
            {
                return craft_response(new String[] {"s_197", "s_216", "s_217"}, 13, player);
    ...
    private int azure_cabal_haadj_handleBranch48(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q2A(player))
            {
                return craft_response(new String[] {"s_358", "s_360", "s_384", "s_403"}, 49, player);
            }
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q2B(player))
            {
                return craft_response(new String[] {"s_286", "s_288", "s_312", "s_401"}, 55, player);
            }
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q2C(player))
            {
                return craft_response(new String[] {"s_396", "s_399", "s_400", "s_402"}, 60, player);
            }
            if (azure_cabal_haadj_condition_onAssignment_30ENF_Q2D(player))
            {
    ...
    private int azure_cabal_haadj_handleBranch49(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_362", "s_364", "s_366", "s_382"}, 50, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch50(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_368", "s_370", "s_372", "s_380"}, 51, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch51(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_374", "s_376", "s_378"}, 52, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch55(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_314", "s_316", "s_318"}, 59, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch56(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_296", "s_298", "s_300", "s_308"}, 57, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch57(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_302", "s_304", "s_306"}, 58, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch60(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_404", "s_406", "s_407"}, 61, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch61(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_408", "s_410", "s_409"}, 62, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch63(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_415", "s_416"}, 64, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch65(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_420", "s_421", "s_422"}, 66, player);
        }
        else if (response.equals("s_418"))
        {
            return craft_response(new String[] {"s_423", "s_424", "s_425"}, 67, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch67(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_426", "s_427", "s_428"}, 68, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch68(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_429", "s_430", "s_431"}, 69, player);
        }
    ...
    private int azure_cabal_haadj_handleBranch69(obj_id player, string_id response) throws InterruptedException
    {
        ...
        {
            return craft_response(new String[] {"s_432", "s_433"}, 70, player);
        }
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        else if (azure_cabal_haadj_condition_onTask_30ENF_Repeater_Q1(player))
        {
        ...
        {
            return craft_repeater(new String[] {"s_282", "s_283", "s_328"}, 48, player, self);
        }
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        if (branchId == 1 && azure_cabal_haadj_handleBranch1(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 3 && azure_cabal_haadj_handleBranch3(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 5 && azure_cabal_haadj_handleBranch5(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 7 && azure_cabal_haadj_handleBranch7(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 9 && azure_cabal_haadj_handleBranch9(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 11 && azure_cabal_haadj_handleBranch11(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 12 && azure_cabal_haadj_handleBranch12(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 13 && azure_cabal_haadj_handleBranch13(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 14 && azure_cabal_haadj_handleBranch14(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 15 && azure_cabal_haadj_handleBranch15(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 16 && azure_cabal_haadj_handleBranch16(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 17 && azure_cabal_haadj_handleBranch17(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 18 && azure_cabal_haadj_handleBranch18(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 19 && azure_cabal_haadj_handleBranch19(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 20 && azure_cabal_haadj_handleBranch20(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 21 && azure_cabal_haadj_handleBranch21(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 22 && azure_cabal_haadj_handleBranch22(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 23 && azure_cabal_haadj_handleBranch23(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 24 && azure_cabal_haadj_handleBranch24(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 25 && azure_cabal_haadj_handleBranch25(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 26 && azure_cabal_haadj_handleBranch26(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 27 && azure_cabal_haadj_handleBranch27(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 28 && azure_cabal_haadj_handleBranch28(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 29 && azure_cabal_haadj_handleBranch29(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 31 && azure_cabal_haadj_handleBranch31(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 32 && azure_cabal_haadj_handleBranch32(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 34 && azure_cabal_haadj_handleBranch34(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 35 && azure_cabal_haadj_handleBranch35(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 36 && azure_cabal_haadj_handleBranch36(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 37 && azure_cabal_haadj_handleBranch37(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 38 && azure_cabal_haadj_handleBranch38(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 40 && azure_cabal_haadj_handleBranch40(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 41 && azure_cabal_haadj_handleBranch41(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 42 && azure_cabal_haadj_handleBranch42(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 43 && azure_cabal_haadj_handleBranch43(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 44 && azure_cabal_haadj_handleBranch44(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 48 && azure_cabal_haadj_handleBranch48(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 49 && azure_cabal_haadj_handleBranch49(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 50 && azure_cabal_haadj_handleBranch50(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 51 && azure_cabal_haadj_handleBranch51(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 52 && azure_cabal_haadj_handleBranch52(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 53 && azure_cabal_haadj_handleBranch53(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 54 && azure_cabal_haadj_handleBranch54(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 55 && azure_cabal_haadj_handleBranch55(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 56 && azure_cabal_haadj_handleBranch56(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 57 && azure_cabal_haadj_handleBranch57(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 58 && azure_cabal_haadj_handleBranch58(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 59 && azure_cabal_haadj_handleBranch59(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 60 && azure_cabal_haadj_handleBranch60(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 61 && azure_cabal_haadj_handleBranch61(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 62 && azure_cabal_haadj_handleBranch62(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 63 && azure_cabal_haadj_handleBranch63(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 64 && azure_cabal_haadj_handleBranch64(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 65 && azure_cabal_haadj_handleBranch65(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 66 && azure_cabal_haadj_handleBranch66(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 67 && azure_cabal_haadj_handleBranch67(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 68 && azure_cabal_haadj_handleBranch68(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 69 && azure_cabal_haadj_handleBranch69(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 70 && azure_cabal_haadj_handleBranch70(player, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
