...
public class outbreak_defense_erlem_math_delta extends script.base_script
{
    ...
    public boolean outbreak_defense_erlem_math_delta_condition_hasCompletedDefenseQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return (groundquests.hasCompletedQuest(player, "camp_delta_defense_01") || groundquests.hasCompletedQuest(player, "camp_delta_defense_02") || groundquests.hasCompletedQuest(player, "camp_delta_defense_03") || groundquests.hasCompletedQuest(player, "camp_delta_defense_04") && outbreak_defense_erlem_math_delta_condition_hasAvailableGuardPosts(player, npc));
    }
    public boolean outbreak_defense_erlem_math_delta_condition_isWaitingForRewardSignal(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "camp_delta_defense_01", "collectRewardDelta") || groundquests.isTaskActive(player, "camp_delta_defense_02", "collectRewardDelta") || groundquests.isTaskActive(player, "camp_delta_defense_03", "collectRewardDelta") || groundquests.isTaskActive(player, "camp_delta_defense_04", "collectRewardDelta");
    }
    public boolean outbreak_defense_erlem_math_delta_condition_hasNeverSpoken(obj_id player, obj_id npc) throws InterruptedException
    {
        return hasCompletedCollectionSlot(player, "exp_icon_deathtroopers_camp_delta") && !groundquests.isQuestActiveOrComplete(player, "camp_delta_defense_01") && !groundquests.isQuestActiveOrComplete(player, "camp_delta_defense_02") && !groundquests.isQuestActiveOrComplete(player, "camp_delta_defense_03") && !groundquests.isQuestActiveOrComplete(player, "camp_delta_defense_04") && outbreak_defense_erlem_math_delta_condition_hasAvailableGuardPosts(player, npc);
    }
    public boolean outbreak_defense_erlem_math_delta_condition_isGodPlayerTester(obj_id player, obj_id npc) throws InterruptedException
    {
        return isGod(player);
    }
    ...
    public boolean outbreak_defense_erlem_math_delta_condition_hasDefenseQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return (groundquests.isQuestActive(player, "camp_delta_defense_01") || groundquests.isQuestActive(player, "camp_delta_defense_02") || groundquests.isQuestActive(player, "camp_delta_defense_03") || groundquests.isQuestActive(player, "camp_delta_defense_04"));
    }
    public boolean outbreak_defense_erlem_math_delta_condition_hasAvailableGuardPosts(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void outbreak_defense_erlem_math_delta_action_giveQuest(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void outbreak_defense_erlem_math_delta_action_sendQuestSignal(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void outbreak_defense_erlem_math_delta_action_action0001(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "camp_delta_defense_01");
    }
    public void outbreak_defense_erlem_math_delta_action_action0002(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "camp_delta_defense_02");
    }
    public void outbreak_defense_erlem_math_delta_action_action0003(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "camp_delta_defense_03");
    }
    public void outbreak_defense_erlem_math_delta_action_action0004(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "camp_delta_defense_04");
    }
    public int outbreak_defense_erlem_math_delta_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int outbreak_defense_erlem_math_delta_handleBranch5(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int outbreak_defense_erlem_math_delta_handleBranch10(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int outbreak_defense_erlem_math_delta_handleBranch11(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int outbreak_defense_erlem_math_delta_handleBranch14(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int outbreak_defense_erlem_math_delta_handleBranch15(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int outbreak_defense_erlem_math_delta_handleBranch16(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("outbreak_defense_erlem_math_delta"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
