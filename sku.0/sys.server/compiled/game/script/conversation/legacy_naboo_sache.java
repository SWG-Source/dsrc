...
public class legacy_naboo_sache extends script.base_script
{
    ...
    public boolean legacy_naboo_sache_condition_isOnCorrectTask(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void legacy_naboo_sache_action_sendSignalAboutSache(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "SacheHasToldMeHerPlan");
    }
    public int legacy_naboo_sache_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("legacy_naboo_sache"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
