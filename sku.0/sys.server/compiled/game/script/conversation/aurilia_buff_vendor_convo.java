...
public class aurilia_buff_vendor_convo extends script.base_script
{
    public aurilia_buff_vendor_convo()
    {
    }
    public static String c_stringFile = "conversation/aurilia_buff_vendor_convo";
    public boolean aurilia_buff_vendor_convo_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public void aurilia_buff_vendor_convo_action_showTokenVendorUI(obj_id player, obj_id npc) throws InterruptedException
    {
