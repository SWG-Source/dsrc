...
public class wod_outcast6 extends script.base_script
{
    ...
    public int wod_outcast6_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            if (wod_outcast6_condition__defaultCondition(player, npc))
            {
    ...
    public int wod_outcast6_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            if (wod_outcast6_condition_talkTaskActive(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.wod_outcast6.branchId", 4);
    ...
    public int wod_outcast6_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            wod_outcast6_action_leanNS(player, npc);
            if (wod_outcast6_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.wod_outcast6.branchId", 5);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        {
            wod_outcast6_action_leanSM(player, npc);
            if (wod_outcast6_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.wod_outcast6.branchId", 7);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_35"))
        {
            ...
            if (wod_outcast6_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.wod_outcast6.branchId", 10);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_36"))
        {
            ...
            if (wod_outcast6_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.wod_outcast6.branchId", 12);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
    ...
    public int wod_outcast6_handleBranch15(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            if (wod_outcast6_condition_leansSM(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.wod_outcast6.branchId", 18);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (wod_outcast6_condition_leansNS(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.wod_outcast6.branchId", 20);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
    ...
    public int wod_outcast6_handleBranch18(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            wod_outcast6_action_sendOutcastSM(player, npc);
            if (wod_outcast6_condition__defaultCondition(player, npc))
            {
    ...
    public int wod_outcast6_handleBranch20(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            wod_outcast6_action_sendOutcastNS(player, npc);
            if (wod_outcast6_condition__defaultCondition(player, npc))
            {
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (!wod_outcast6_condition_hasQuestActive(player, npc))
        {
        ...
        if (!wod_outcast6_condition_condition0003(player, npc))
        {
        ...
        if (!wod_outcast6_condition_condition0004(player, npc))
        {
        ...
        if (!wod_outcast6_condition_condition0005(player, npc))
        {
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        obj_id npc = self;
        int branchId = utils.getIntScriptVar(player, "conversation.wod_outcast6.branchId");
        if (branchId == 1 && wod_outcast6_handleBranch1(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 3 && wod_outcast6_handleBranch3(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 4 && wod_outcast6_handleBranch4(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 5 && wod_outcast6_handleBranch5(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 6 && wod_outcast6_handleBranch6(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 7 && wod_outcast6_handleBranch7(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 8 && wod_outcast6_handleBranch8(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 9 && wod_outcast6_handleBranch9(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 10 && wod_outcast6_handleBranch10(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 11 && wod_outcast6_handleBranch11(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 12 && wod_outcast6_handleBranch12(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 13 && wod_outcast6_handleBranch13(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 14 && wod_outcast6_handleBranch14(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 15 && wod_outcast6_handleBranch15(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 16 && wod_outcast6_handleBranch16(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 17 && wod_outcast6_handleBranch17(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 18 && wod_outcast6_handleBranch18(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 20 && wod_outcast6_handleBranch20(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
