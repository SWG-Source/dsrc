...
public class nexus_ig88_starter extends script.base_script
{
    ...
    public boolean nexus_ig88_starter_condition_needsQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return !groundquests.isQuestActiveOrComplete(player, "feeder_ig88_01");
    }
    public boolean nexus_ig88_starter_condition_onQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return (groundquests.isQuestActive(player, "feeder_ig88_01") || groundquests.isQuestActive(player, "found_ig88_encounter"));
    }
    public boolean nexus_ig88_starter_condition_finishedQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedQuest(player, "found_ig88_encounter");
    }
    public void nexus_ig88_starter_action_giveQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "feeder_ig88_01");
    }
    public int nexus_ig88_starter_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int nexus_ig88_starter_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("nexus_ig88_starter"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
