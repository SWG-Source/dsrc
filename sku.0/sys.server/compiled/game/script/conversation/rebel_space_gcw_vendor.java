...
public class rebel_space_gcw_vendor extends script.base_script
{
    ...
    public int OnInitialize(obj_id self) throws InterruptedException
    {
        ...
        {
            detachScript(self, "conversation.rebel_space_gcw_vendor");
        }
    ...
    {
        if (!conversationId.equals("rebel_space_gcw_vendor"))
        {
            return SCRIPT_CONTINUE;
        }
        chat.chat(self, "Error:  Fell through all branches and responses for OnNpcConversationResponse.");
        utils.removeScriptVar(player, "conversation.rebel_space_gcw_vendor.branchId");
        return SCRIPT_CONTINUE;
    }
}
