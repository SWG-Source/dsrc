...
public class injured_agent extends script.base_script
{
    ...
    public boolean injured_agent_condition_doneReturn(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int injured_agent_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
