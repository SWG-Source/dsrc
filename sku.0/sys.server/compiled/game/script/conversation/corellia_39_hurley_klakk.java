...
public class corellia_39_hurley_klakk extends script.base_script
{
    ...
    public boolean corellia_39_hurley_klakk_condition_taskOneActive(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "corellia_39_sidequest_06");
    }
    public boolean corellia_39_hurley_klakk_condition_taskOneComplete(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "corellia_39_sidequest_06", "corellia_39_sidequest_06_02") || groundquests.hasCompletedQuest(player, "corellia_39_sidequest_06");
    }
    public void corellia_39_hurley_klakk_action_questGranted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "corellia_39_sidequest_06");
    }
    public void corellia_39_hurley_klakk_action_taskOneCompletedSignal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "corellia_39_sidequest_06_02");
    }
    public int corellia_39_hurley_klakk_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("corellia_39_hurley_klakk"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
