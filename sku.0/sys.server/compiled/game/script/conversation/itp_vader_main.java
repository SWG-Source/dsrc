...
public class itp_vader_main extends script.base_script
{
    ...
    public boolean itp_vader_main_condition_itp_vader_01_active(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "itp_vader_01");
    }
    public boolean itp_vader_main_condition_itp_vader_01_complete(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "itp_vader_01", "itp_vader_01_04") || groundquests.hasCompletedQuest(player, "itp_vader_01");
    }
    public boolean itp_vader_main_condition_itp_vader_02_active(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "itp_vader_02");
    }
    public boolean itp_vader_main_condition_itp_vader_03_complete(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "itp_vader_03", "itp_vader_03_04") || groundquests.hasCompletedQuest(player, "itp_vader_03");
    }
    public boolean itp_vader_main_condition_itp_vader_03_active(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "itp_vader_03");
    }
    public boolean itp_vader_main_condition_itp_vader_02_complete(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "itp_vader_02", "itp_vader_02_05") || groundquests.hasCompletedQuest(player, "itp_vader_02");
    }
    public boolean itp_vader_main_condition_completedEmperor(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedQuest(player, "itp_emperor_03");
    }
    public boolean itp_vader_main_condition_notImperial(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean itp_vader_main_condition_imperial_isOnLeave(obj_id player, obj_id npc) throws InterruptedException
    {
        return factions.isOnLeave(player);
    }
    public void itp_vader_main_action_itp_vader_01_granted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "itp_vader_01");
    }
    public void itp_vader_main_action_itp_vader_01_signal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "itp_vader_01_04");
    }
    public void itp_vader_main_action_itp_vader_03_signal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "itp_vader_03_04");
    }
    public void itp_vader_main_action_itp_vader_02_signal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "itp_vader_02_05");
    }
    public void itp_vader_main_action_itp_vader_02_granted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "itp_vader_02");
    }
    public void itp_vader_main_action_itp_vader_03_granted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "itp_vader_03");
    }
    public int itp_vader_main_handleBranch6(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int itp_vader_main_handleBranch10(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int itp_vader_main_handleBranch14(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("itp_vader_main"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
