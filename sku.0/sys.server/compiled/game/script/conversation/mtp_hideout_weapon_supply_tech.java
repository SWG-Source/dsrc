...
public class mtp_hideout_weapon_supply_tech extends script.base_script
{
	...
	public int mtp_hideout_weapon_supply_tech_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
	...
	public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
	{
		...
		if (mtp_hideout_weapon_supply_tech_condition__defaultCondition (player, npc))
		{
			...
			if (hasResponse)
			{
				...
				utils.setScriptVar (player, "conversation.mtp_hideout_weapon_supply_tech.branchId", 1);
	...
	public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
	{
		...
		if (branchId == 1 && mtp_hideout_weapon_supply_tech_handleBranch1 (player, npc, response) == SCRIPT_CONTINUE)
		{
			return SCRIPT_CONTINUE;
		}
