...
public class c_smuggler_awrada extends script.base_script
{
    ...
    public boolean c_smuggler_awrada_condition_isTaskActiveSteal2(obj_id player, obj_id npc) throws InterruptedException
    {
        return (groundquests.isTaskActive(player, "c_smuggler_steal_2", "person1"));
    }
    public void c_smuggler_awrada_action_giveSignalSteal2(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "person1");
    }
    public int c_smuggler_awrada_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
