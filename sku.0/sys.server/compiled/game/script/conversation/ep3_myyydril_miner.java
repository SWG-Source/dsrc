...
public class ep3_myyydril_miner extends script.base_script
{
    public ep3_myyydril_miner()
    {
    }
    public static String c_stringFile = "conversation/ep3_myyydril_miner";
    public boolean ep3_myyydril_miner_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean ep3_myyydril_miner_condition_hasLanguage(obj_id player, obj_id npc) throws InterruptedException
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_myyydril_miner_action_Language(obj_id player, obj_id npc) throws InterruptedException
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_myyydril_miner_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int ep3_myyydril_miner_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int ep3_myyydril_miner_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("ep3_myyydril_miner"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
