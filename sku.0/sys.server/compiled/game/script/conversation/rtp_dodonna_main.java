...
public class rtp_dodonna_main extends script.base_script
{
    ...
    public boolean rtp_dodonna_main_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean rtp_dodonna_main_condition_rtp_dodonna_01_active(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "rtp_dodonna_01");
    }
    public boolean rtp_dodonna_main_condition_rtp_dodonna_01_complete(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean rtp_dodonna_main_condition_rtp_dodonna_02_active(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "rtp_dodonna_02");
    }
    public boolean rtp_dodonna_main_condition_rtp_dodonna_03_complete(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean rtp_dodonna_main_condition_rtp_dodonna_03_active(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "rtp_dodonna_03");
    }
    public boolean rtp_dodonna_main_condition_rtp_dodonna_02_complete(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean rtp_dodonna_main_condition_completedMonMothma(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedQuest(player, "rtp_mon_mothma_01");
    }
    public boolean rtp_dodonna_main_condition_notRebel(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean rtp_dodonna_main_condition_rebel_isOnLeave(obj_id player, obj_id npc) throws InterruptedException
    {
        return factions.isOnLeave(player);
    }
    public void rtp_dodonna_main_action_rtp_dodonna_01_granted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "rtp_dodonna_01");
    }
    public void rtp_dodonna_main_action_rtp_dodonna_01_signal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "rtp_dodonna_01_02");
    }
    public void rtp_dodonna_main_action_rtp_dodonna_03_signal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "rtp_dodonna_03_02");
    }
    public void rtp_dodonna_main_action_rtp_dodonna_02_signal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "rtp_dodonna_02_02");
    }
    public void rtp_dodonna_main_action_rtp_dodonna_02_granted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "rtp_dodonna_02");
    }
    public void rtp_dodonna_main_action_rtp_dodonna_03_granted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "rtp_dodonna_03");
    }
    public int rtp_dodonna_main_handleBranch6(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int rtp_dodonna_main_handleBranch10(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int rtp_dodonna_main_handleBranch14(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
