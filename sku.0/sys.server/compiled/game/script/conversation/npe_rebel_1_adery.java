...
public class npe_rebel_1_adery extends script.base_script
{
    ...
    public boolean npe_rebel_1_adery_condition_hasRebQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "npe_rebel_1", "adery");
    }
    public void npe_rebel_1_adery_action_signalReb(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "npe_rebel_1_adery");
    }
    public void npe_rebel_1_adery_action_facePlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
    }
    public int npe_rebel_1_adery_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int npe_rebel_1_adery_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("npe_rebel_1_adery"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
