...
public class racing_keren extends script.base_script
{
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (racing_keren_condition_isRacing(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_6a5b9858");
            int numberOfResponses = 0;
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (racing_keren_condition__defaultCondition(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse0 = true;
        ...
        if (racing_keren_condition_hasLastTime(player, self))
        {
            racing_keren_action_registerPersonalBest(player, self);
            string_id message = new string_id(c_stringFile, "s_891e1f6");
            chat.chat(self, message);
            return SCRIPT_CONTINUE;
        }
        if (racing_keren_condition_hasRaced(player, self))
        {
        ...
        if (racing_keren_condition__defaultCondition(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_46163ea3");
            int numberOfResponses = 0;
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (racing_keren_condition__defaultCondition(player, self))
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        int branchId = getIntObjVar(player, "conversation.racing_keren.branchId");
        if (branchId == 1 && response.equals("s_d900d1be"))
        {
            racing_keren_action_abortRace(player, self);
            if (racing_keren_condition__defaultCondition(player, self))
            {
        ...
        if (branchId == 4 && response.equals("s_ed644123"))
        {
            if (racing_keren_condition__defaultCondition(player, self))
            {
                ...
                if (hasResponse)
                {
                    ...
                    setObjVar(player, "conversation.racing_keren.branchId", 5);
                    npcSpeak(player, message);
        ...
        {
            racing_keren_action_displayCurrentLeader(player, self);
            if (racing_keren_condition__defaultCondition(player, self))
            {
        ...
        {
            racing_keren_action_whatsMyBestTime(player, self);
            if (racing_keren_condition__defaultCondition(player, self))
            {
        ...
        if (branchId == 4 && response.equals("s_59d4e0ee"))
        {
            if (racing_keren_condition__defaultCondition(player, self))
            {
                ...
                if (hasResponse)
                {
                    ...
                    setObjVar(player, "conversation.racing_keren.branchId", 10);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (branchId == 4 && response.equals("s_1736e216"))
        {
            if (racing_keren_condition__defaultCondition(player, self))
            {
                string_id message = new string_id(c_stringFile, "s_ba9eff79");
                int numberOfResponses = 0;
                boolean hasResponse = false;
                boolean hasResponse0 = false;
                if (racing_keren_condition__defaultCondition(player, self))
        ...
        {
            racing_keren_action_startRace(player, self);
            if (racing_keren_condition__defaultCondition(player, self))
            {
        ...
        {
            racing_keren_action_erasePersonalBest(player, self);
            if (racing_keren_condition__defaultCondition(player, self))
            {
        ...
        if (branchId == 14 && response.equals("s_ed644123"))
        {
            ...
            chat.chat(self, "Error:  All conditions for OnNpcConversationResponse for branch 'This circuit will take you winding through the narrow bridges and streets of Keren and it is favored by the more technically minded racer. Focusing more on finesse then it does raw speed this course will definately challenge your racing skills. Due to the danger street racing poses to pedestrians, the RSF does not approve of this activity so participation is at your own risk.' were false.");
            return SCRIPT_CONTINUE;
        }
        ...
        if (branchId == 15 && response.equals("s_e460e3d3"))
        {
            ...
            chat.chat(self, "Error:  All conditions for OnNpcConversationResponse for branch 'Greetings, I'm the coordinator for the Keren Street Race. If you'd like to race the track, just let me know. How may I serve you today?' were false.");
            return SCRIPT_CONTINUE;
        }
        ...
        if (branchId == 15 && response.equals("s_dffdee4b"))
        {
            if (racing_keren_condition__defaultCondition(player, self))
            {
                ...
                if (hasResponse)
                {
                    ...
                    setObjVar(player, "conversation.racing_keren.branchId", 18);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
