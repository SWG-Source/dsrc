...
public class cyborg_install_naboo extends script.base_script
{
    ...
    public boolean cyborg_install_naboo_condition_tooManyInstalled(obj_id player, obj_id npc) throws InterruptedException
    {
        return cybernetic.hasMaxInstalled(player);
    }
    public boolean cyborg_install_naboo_condition_hasCyberneticOnHand(obj_id player, obj_id npc) throws InterruptedException
    {
        return cybernetic.hasCyberneticItemInInventory(player);
    }
    public boolean cyborg_install_naboo_condition_hasCyberneticInstalled(obj_id player, obj_id npc) throws InterruptedException
    {
        return cybernetic.hasCyberneticItem(player);
    }
    public boolean cyborg_install_naboo_condition_canGetRepairs(obj_id player, obj_id npc) throws InterruptedException
    {
        return cybernetic.hasCyberneticsToRepair(player);
    }
    public void cyborg_install_naboo_action_listCyberneticsToInstall(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void cyborg_install_naboo_action_listCyberneticsToRemove(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void cyborg_install_naboo_action_listCyberneticsToRepair(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void cyborg_install_naboo_action_trackAppearanceTabCyb(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void cyborg_install_naboo_action_resetAppearanceTabTracker(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int cyborg_install_naboo_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int cyborg_install_naboo_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int cyborg_install_naboo_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int cyborg_install_naboo_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int cyborg_install_naboo_handleBranch5(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int cyborg_install_naboo_handleBranch6(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int cyborg_install_naboo_handleBranch7(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int cyborg_install_naboo_handleBranch10(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("cyborg_install_naboo"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
