...
public class corellia_39_teniel_waray extends script.base_script
{
    ...
    public boolean corellia_39_teniel_waray_condition_taskOneActive(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "corellia_39_sidequest_04");
    }
    public boolean corellia_39_teniel_waray_condition_taskOneComplete(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "corellia_39_sidequest_04", "corellia_39_sidequest_04_02") || groundquests.hasCompletedQuest(player, "corellia_39_sidequest_04");
    }
    public void corellia_39_teniel_waray_action_questGranted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "corellia_39_sidequest_04");
    }
    public void corellia_39_teniel_waray_action_taskOneCompletedSignal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "corellia_39_sidequest_04_02");
    }
    public int corellia_39_teniel_waray_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("corellia_39_teniel_waray"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
