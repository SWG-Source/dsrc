...
public class station_tatooine_mining extends script.base_script
{
    public station_tatooine_mining()
    {
    }
    public static String c_stringFile = "conversation/station_tatooine_mining";
    public boolean station_tatooine_mining_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public void station_tatooine_mining_action_sellResources(obj_id player, obj_id npc) throws InterruptedException
    {
        space_crafting.sellResourcesToSpaceStation(player, npc);
    }
    public int station_tatooine_mining_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("station_tatooine_mining"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
