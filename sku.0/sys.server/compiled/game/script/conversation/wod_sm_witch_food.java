...
public class wod_sm_witch_food extends script.base_script
{
    ...
    public void wod_sm_witch_food_action_grantTPHuntingSM(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        {
            groundquests.clearQuest(player, "quest/wod_themepark_sm_hunting");
        }
    ...
    public void wod_sm_witch_food_action_grantTPFishingSM(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        {
            groundquests.clearQuest(player, "quest/wod_themepark_sm_fishing");
        }
    ...
    public int wod_sm_witch_food_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            wod_sm_witch_food_action_sendReturnedSignalHuntingSM(player, npc);
            if (wod_sm_witch_food_condition__defaultCondition(player, npc))
            {
                string_id message = new string_id(c_stringFile, "s_35");
                utils.removeScriptVar(player, "conversation.wod_sm_witch_food.branchId");
    ...
    public int wod_sm_witch_food_handleBranch5(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            wod_sm_witch_food_action_sendReturnedSignalFishingSM(player, npc);
            if (wod_sm_witch_food_condition__defaultCondition(player, npc))
            {
                string_id message = new string_id(c_stringFile, "s_35");
                utils.removeScriptVar(player, "conversation.wod_sm_witch_food.branchId");
    ...
    public int wod_sm_witch_food_handleBranch7(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            if (wod_sm_witch_food_condition_QuestIsActiveNSHunting(player, npc))
            {
            ...
            if (wod_sm_witch_food_condition_QuestIsActiveSMHunting(player, npc))
            {
            ...
            if (wod_sm_witch_food_condition__defaultCondition(player, npc))
            {
                wod_sm_witch_food_action_grantTPHuntingSM(player, npc);
        ...
        {
            if (wod_sm_witch_food_condition_QuestIsActiveNSFishing(player, npc))
            {
                string_id message = new string_id(c_stringFile, "s_11");
                utils.removeScriptVar(player, "conversation.wod_sm_witch_food.branchId");
                npcEndConversationWithMessage(player, message);
            ...
            if (wod_sm_witch_food_condition_QuestIsActiveSMFishing(player, npc))
            {
            ...
            if (wod_sm_witch_food_condition__defaultCondition(player, npc))
            {
                wod_sm_witch_food_action_grantTPFishingSM(player, npc);
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (wod_sm_witch_food_condition_IsNS(player, npc))
        {
            string_id message = new string_id(c_stringFile, "s_5");
            chat.chat(npc, player, message);
            return SCRIPT_CONTINUE;
        }
        if (wod_sm_witch_food_condition_IsIndifferent(player, npc))
        {
            string_id message = new string_id(c_stringFile, "s_7");
            chat.chat(npc, player, message);
            return SCRIPT_CONTINUE;
        }
        if (wod_sm_witch_food_condition_OnReturnHuntingSM(player, npc))
        {
        ...
        if (wod_sm_witch_food_condition_OnReturnFishingSM(player, npc))
        {
        ...
        if (wod_sm_witch_food_condition_hasPreqComplete(player, npc))
        {
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        obj_id npc = self;
        int branchId = utils.getIntScriptVar(player, "conversation.wod_sm_witch_food.branchId");
        if (branchId == 3 && wod_sm_witch_food_handleBranch3(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 5 && wod_sm_witch_food_handleBranch5(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 7 && wod_sm_witch_food_handleBranch7(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
