...
public class corvette_imperial_prisoner extends script.base_script
{
    public corvette_imperial_prisoner()
    {
    }
    public static String c_stringFile = "conversation/corvette_imperial_prisoner";
    public boolean corvette_imperial_prisoner_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean corvette_imperial_prisoner_condition_rescued(obj_id player, obj_id npc) throws InterruptedException
    {
        return hasObjVar(npc, "corl_corvette.alreadyRescued");
    }
    public void corvette_imperial_prisoner_action__defaultAction(obj_id player, obj_id npc) throws InterruptedException
    {
    }
    public void corvette_imperial_prisoner_action_factionReward(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
    ...
    public void corvette_imperial_prisoner_action_face_player(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
        return;
    }
    ...
    {
        if (!conversationId.equals("corvette_imperial_prisoner"))
        {
            return SCRIPT_CONTINUE;
        }
