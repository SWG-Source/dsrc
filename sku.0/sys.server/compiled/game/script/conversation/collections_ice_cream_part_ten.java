...
public class collections_ice_cream_part_ten extends script.base_script
{
    public collections_ice_cream_part_ten()
    {
    }
    public static String c_stringFile = "conversation/collections_ice_cream_part_ten";
    public boolean collections_ice_cream_part_ten_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean collections_ice_cream_part_ten_condition_hasActiveTask(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void collections_ice_cream_part_ten_action_signalNextTask(obj_id player, obj_id npc) throws InterruptedException
    {
        modifyCollectionSlotValue(player, "col_fried_icecream_part_10", 1);
        groundquests.sendSignal(player, "meet_ice_cream_man");
    }
    public int collections_ice_cream_part_ten_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("collections_ice_cream_part_ten"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
