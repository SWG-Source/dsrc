...
public class aurilia_nightsister_prisoner extends script.base_script
{
    public aurilia_nightsister_prisoner()
    {
    }
    public static String c_stringFile = "conversation/aurilia_nightsister_prisoner";
    public boolean aurilia_nightsister_prisoner_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean aurilia_nightsister_prisoner_condition_onAxkvaMinQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "axkva_min_intro", "axkva_min_intro_01");
    }
    public void aurilia_nightsister_prisoner_action_axkvaMinSignal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "axkva_min_intro_01");
    }
    public int aurilia_nightsister_prisoner_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
