...
public class aurilia_quharek extends script.base_script
{
    public aurilia_quharek()
    {
    }
    public static String c_stringFile = "conversation/aurilia_quharek";
    public boolean aurilia_quharek_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean aurilia_quharek_condition_axkva_min_intro_01(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "axkva_min_intro", "axkva_min_intro_01");
    }
    public int aurilia_quharek_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
