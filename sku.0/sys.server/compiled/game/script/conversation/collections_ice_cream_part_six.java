...
public class collections_ice_cream_part_six extends script.base_script
{
    public collections_ice_cream_part_six()
    {
    }
    public static String c_stringFile = "conversation/collections_ice_cream_part_six";
    public boolean collections_ice_cream_part_six_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean collections_ice_cream_part_six_condition_hasActiveTask(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void collections_ice_cream_part_six_action_signalNextTask(obj_id player, obj_id npc) throws InterruptedException
    {
        modifyCollectionSlotValue(player, "col_fried_icecream_part_06", 1);
        groundquests.sendSignal(player, "meet_tombl_blaus");
    }
    public int collections_ice_cream_part_six_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int collections_ice_cream_part_six_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int collections_ice_cream_part_six_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int collections_ice_cream_part_six_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int collections_ice_cream_part_six_handleBranch5(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("collections_ice_cream_part_six"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
