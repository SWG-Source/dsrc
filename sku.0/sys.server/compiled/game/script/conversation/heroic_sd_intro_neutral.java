...
public class heroic_sd_intro_neutral extends script.base_script
{
    public heroic_sd_intro_neutral()
    {
    }
    public static String c_stringFile = "conversation/heroic_sd_intro_neutral";
    public boolean heroic_sd_intro_neutral_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean heroic_sd_intro_neutral_condition_notNeutralFaction(obj_id player, obj_id npc) throws InterruptedException
    {
        return factions.isImperial(player) || factions.isRebel(player);
    }
    public boolean heroic_sd_intro_neutral_condition_onQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "star_destroyer_intro_neutral");
    }
    public boolean heroic_sd_intro_neutral_condition_returningQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "star_destroyer_intro_neutral", "star_destroyer_intro_07") || groundquests.hasCompletedQuest(player, "star_destroyer_intro_neutral");
    }
    public void heroic_sd_intro_neutral_action_grantIntroQuest(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void heroic_sd_intro_neutral_action_sendIntroSignal(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int heroic_sd_intro_neutral_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("heroic_sd_intro_neutral"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
