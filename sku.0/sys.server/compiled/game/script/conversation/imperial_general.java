...
public class imperial_general extends script.base_script
{
	...
	public int imperial_general_handleBranch12(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
		...
		if (response.equals("s_81"))
		{
			...
			if (imperial_general_condition_isCombatPhase (player, npc))
			{
				...
				boolean hasResponse0 = false;
				if (imperial_general_condition_patrolPointsExistNoScoutQuest (player, npc))
				{
					++numberOfResponses;
					hasResponse = true;
					hasResponse0 = true;
				...
				boolean hasResponse1 = false;
				if (imperial_general_condition_patrolPointsExistNoDestroyQuest (player, npc))
				{
					++numberOfResponses;
					hasResponse = true;
					hasResponse1 = true;
				...
				if (hasResponse)
				{
					...
					utils.setScriptVar (player, "conversation.imperial_general.branchId", 25);
	...
	public int imperial_general_handleBranch25(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
		...
		if (response.equals("s_197"))
		{
			...
			if (imperial_general_condition__defaultCondition (player, npc))
			{
				imperial_general_action_grantSpyScoutPatrol (player, npc);
		...
		if (response.equals("s_198"))
		{
			...
			if (imperial_general_condition__defaultCondition (player, npc))
			{
				imperial_general_action_grantSpyDestroyPatrol (player, npc);
	...
	public int imperial_general_handleBranch39(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
		...
		if (response.equals("s_126"))
		{
			...
			if (imperial_general_condition_isCombatPhase (player, npc))
			{
				...
				if (hasResponse)
				{
					...
					utils.setScriptVar (player, "conversation.imperial_general.branchId", 40);
			...
			if (imperial_general_condition_isConstructionPhase (player, npc))
			{
				...
				if (hasResponse)
				{
					...
					utils.setScriptVar (player, "conversation.imperial_general.branchId", 44);
		...
		if (response.equals("s_233"))
		{
			...
			if (imperial_general_condition_enemyPatrolsExistAndIsCombatPhase (player, npc))
			{
				...
				if (hasResponse)
				{
					...
					utils.setScriptVar (player, "conversation.imperial_general.branchId", 58);
	...
	public int imperial_general_handleBranch40(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
		...
		if (response.equals("s_277"))
		{
			...
			if (imperial_general_condition__defaultCondition (player, npc))
			{
				...
				if (hasResponse)
				{
					...
					utils.setScriptVar (player, "conversation.imperial_general.branchId", 41);
	...
	public int imperial_general_handleBranch41(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
		...
		if (response.equals("s_279"))
		{
			...
			if (imperial_general_condition__defaultCondition (player, npc))
			{
				imperial_general_action_grantEntertainRallyQuest (player, npc);
	...
	public int imperial_general_handleBranch44(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
	...
	public int imperial_general_handleBranch58(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
		...
		if (response.equals("s_245"))
		{
			...
			if (imperial_general_condition__defaultCondition (player, npc))
			{
				...
				if (hasResponse)
				{
					...
					utils.setScriptVar (player, "conversation.imperial_general.branchId", 59);
		...
		if (response.equals("s_261"))
		{
			...
			if (imperial_general_condition__defaultCondition (player, npc))
			{
				...
				if (hasResponse)
				{
					...
					utils.setScriptVar (player, "conversation.imperial_general.branchId", 61);
	...
	public int imperial_general_handleBranch59(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
	...
	public int imperial_general_handleBranch61(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
		...
		if (response.equals("s_269"))
		{
			...
			if (imperial_general_condition__defaultCondition (player, npc))
			{
				...
				if (hasResponse)
				{
					...
					utils.setScriptVar (player, "conversation.imperial_general.branchId", 62);
	...
	public int imperial_general_handleBranch62(obj_id player, obj_id npc, string_id response) throws InterruptedException
	{
	...
	public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
	{
		...
		if (branchId == 25 && imperial_general_handleBranch25 (player, npc, response) == SCRIPT_CONTINUE)
		{
			return SCRIPT_CONTINUE;
		}
		...
		if (branchId == 40 && imperial_general_handleBranch40 (player, npc, response) == SCRIPT_CONTINUE)
		{
			return SCRIPT_CONTINUE;
		}
		
		if (branchId == 41 && imperial_general_handleBranch41 (player, npc, response) == SCRIPT_CONTINUE)
		{
			return SCRIPT_CONTINUE;
		}
		
		if (branchId == 44 && imperial_general_handleBranch44 (player, npc, response) == SCRIPT_CONTINUE)
		{
			return SCRIPT_CONTINUE;
		}
		
		if (branchId == 58 && imperial_general_handleBranch58 (player, npc, response) == SCRIPT_CONTINUE)
		{
			return SCRIPT_CONTINUE;
		}
		
		if (branchId == 59 && imperial_general_handleBranch59 (player, npc, response) == SCRIPT_CONTINUE)
		{
			return SCRIPT_CONTINUE;
		}
		
		if (branchId == 61 && imperial_general_handleBranch61 (player, npc, response) == SCRIPT_CONTINUE)
		{
			return SCRIPT_CONTINUE;
		}
		
		if (branchId == 62 && imperial_general_handleBranch62 (player, npc, response) == SCRIPT_CONTINUE)
		{
			return SCRIPT_CONTINUE;
		}
