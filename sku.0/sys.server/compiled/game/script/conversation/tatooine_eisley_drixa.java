...
public class tatooine_eisley_drixa extends script.base_script
{
    ...
    public boolean tatooine_eisley_drixa_condition_tdcOnTask1(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean tatooine_eisley_drixa_condition_tdcQuestComplete(obj_id player, obj_id npc) throws InterruptedException
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_tdc");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public void tatooine_eisley_drixa_action_signalDrixaDelivered(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "tat_eisley_tdc_e1");
    }
    public int tatooine_eisley_drixa_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("tatooine_eisley_drixa"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
