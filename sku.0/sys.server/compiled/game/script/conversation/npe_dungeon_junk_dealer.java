...
public class npe_dungeon_junk_dealer extends script.base_script
{
    public npe_dungeon_junk_dealer()
    {
    }
    public static String c_stringFile = "conversation/npe_dungeon_junk_dealer";
    public boolean npe_dungeon_junk_dealer_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean npe_dungeon_junk_dealer_condition_check_inv(obj_id player, obj_id npc) throws InterruptedException
    {
        return smuggler.checkInventory(player, npc);
    }
    public void npe_dungeon_junk_dealer_action_start_dealing(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 1.0f, false);
    }
    public void npe_dungeon_junk_dealer_action_facePlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
    }
    public int npe_dungeon_junk_dealer_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int npe_dungeon_junk_dealer_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("npe_dungeon_junk_dealer"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
