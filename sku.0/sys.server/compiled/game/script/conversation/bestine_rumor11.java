...
public class bestine_rumor11 extends script.base_script
{
    ...
    public boolean bestine_rumor11_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean bestine_rumor11_condition_nonoffice(obj_id player, obj_id npc) throws InterruptedException
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void bestine_rumor11_action__defaultAction(obj_id player, obj_id npc) throws InterruptedException
    {
    }
