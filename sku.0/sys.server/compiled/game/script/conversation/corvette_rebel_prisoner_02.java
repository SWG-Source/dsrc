...
public class corvette_rebel_prisoner_02 extends script.base_script
{
    public corvette_rebel_prisoner_02()
    {
    }
    public static String c_stringFile = "conversation/corvette_rebel_prisoner_02";
    public boolean corvette_rebel_prisoner_02_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean corvette_rebel_prisoner_02_condition_rescued(obj_id player, obj_id npc) throws InterruptedException
    {
        return hasObjVar(npc, "corl_corvette.alreadyRescued");
    }
    public void corvette_rebel_prisoner_02_action__defaultAction(obj_id player, obj_id npc) throws InterruptedException
    {
    }
    public void corvette_rebel_prisoner_02_action_factionReward(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
    ...
    public void corvette_rebel_prisoner_02_action_facePlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        faceTo(npc, player);
        return;
    }
    ...
    {
        if (!conversationId.equals("corvette_rebel_prisoner_02"))
        {
            return SCRIPT_CONTINUE;
        }
