...
public class racing_nashal extends script.base_script
{
    public racing_nashal()
    {
    }
    public static String c_stringFile = "conversation/racing_nashal";
    public boolean racing_nashal_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean racing_nashal_condition_hasRaced(obj_id player, obj_id npc) throws InterruptedException
    {
        return (hasObjVar(player, "racing.bestTime.nashal"));
    }
    public boolean racing_nashal_condition_isRacing(obj_id player, obj_id npc) throws InterruptedException
    {
        return (getIntObjVar(player, "racing.nashal.isRacing") == 1);
    }
    public boolean racing_nashal_condition_hasLastTime(obj_id player, obj_id npc) throws InterruptedException
    {
        return (hasObjVar(player, "racing.lastTime.nashal"));
    }
    public void racing_nashal_action_registerPersonalBest(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void racing_nashal_action_startRace(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_nashal_action_displayCurrentLeader(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_nashal_action_whatsMyBestTime(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_nashal_action_showBestTime(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_nashal_action_erasePersonalBest(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_nashal_action_abortRace(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    public int OnInitialize(obj_id self) throws InterruptedException
    {
        ...
        {
            detachScript(self, "npc.conversation.racing_nashal");
        }
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (racing_nashal_condition_isRacing(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_6a5b9858");
            int numberOfResponses = 0;
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (racing_nashal_condition__defaultCondition(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse0 = true;
            ...
            if (hasResponse)
            {
                ...
                setObjVar(player, "conversation.racing_nashal.branchId", 1);
                npcStartConversation(player, self, "racing_nashal", message, responses);
            }
            else 
            {
        ...
        if (racing_nashal_condition_hasLastTime(player, self))
        {
            racing_nashal_action_registerPersonalBest(player, self);
            string_id message = new string_id(c_stringFile, "s_891e1f6");
            chat.chat(self, message);
            return SCRIPT_CONTINUE;
        }
        if (racing_nashal_condition_hasRaced(player, self))
        {
            ...
            if (hasResponse)
            {
                ...
                setObjVar(player, "conversation.racing_nashal.branchId", 4);
                npcStartConversation(player, self, "racing_nashal", message, responses);
            }
            else 
            {
        ...
        if (racing_nashal_condition__defaultCondition(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_8643c312");
            int numberOfResponses = 0;
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (racing_nashal_condition__defaultCondition(player, self))
            ...
            if (hasResponse)
            {
                ...
                setObjVar(player, "conversation.racing_nashal.branchId", 15);
                npcStartConversation(player, self, "racing_nashal", message, responses);
            }
            else 
            {
    ...
    {
        if (!conversationId.equals("racing_nashal"))
        {
            return SCRIPT_CONTINUE;
        }
        int branchId = getIntObjVar(player, "conversation.racing_nashal.branchId");
        if (branchId == 1 && response.equals("s_d900d1be"))
        {
            racing_nashal_action_abortRace(player, self);
            if (racing_nashal_condition__defaultCondition(player, self))
            {
                string_id message = new string_id(c_stringFile, "s_6441a2a6");
                removeObjVar(player, "conversation.racing_nashal.branchId");
        ...
        if (branchId == 4 && response.equals("s_ed644123"))
        {
            if (racing_nashal_condition__defaultCondition(player, self))
            {
                ...
                if (hasResponse)
                {
                    ...
                    setObjVar(player, "conversation.racing_nashal.branchId", 5);
                    npcSpeak(player, message);
        ...
        {
            racing_nashal_action_displayCurrentLeader(player, self);
            if (racing_nashal_condition__defaultCondition(player, self))
            {
        ...
        {
            racing_nashal_action_whatsMyBestTime(player, self);
            if (racing_nashal_condition__defaultCondition(player, self))
            {
        ...
        if (branchId == 4 && response.equals("s_59d4e0ee"))
        {
            if (racing_nashal_condition__defaultCondition(player, self))
            {
                ...
                if (hasResponse)
                {
                    ...
                    setObjVar(player, "conversation.racing_nashal.branchId", 10);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (branchId == 4 && response.equals("s_1736e216"))
        {
            if (racing_nashal_condition__defaultCondition(player, self))
            {
                string_id message = new string_id(c_stringFile, "s_f1970106");
                int numberOfResponses = 0;
                boolean hasResponse = false;
                boolean hasResponse0 = false;
                if (racing_nashal_condition__defaultCondition(player, self))
        ...
        {
            racing_nashal_action_startRace(player, self);
            if (racing_nashal_condition__defaultCondition(player, self))
            {
        ...
        {
            racing_nashal_action_erasePersonalBest(player, self);
            if (racing_nashal_condition__defaultCondition(player, self))
            {
        ...
        if (branchId == 14 && response.equals("s_ed644123"))
        {
            ...
            chat.chat(self, "Error:  All conditions for OnNpcConversationResponse for branch 'Mostly this track has been used for recreation and youth races; very few professional events have been staged here. The course primarily sticks to major waterways around Nashal and therefore is impractical for mount or foot racing. On a hover vehicle, it is considered a delightful afternoon outing.' were false.");
            return SCRIPT_CONTINUE;
        }
        ...
        if (branchId == 15 && response.equals("s_e460e3d3"))
        {
            ...
            chat.chat(self, "Error:  All conditions for OnNpcConversationResponse for branch 'Greetings, I'm the coordinator for the Nashal River Race. If you'd like to race the track, just let me know. How may I serve you today?' were false.");
            return SCRIPT_CONTINUE;
        }
        ...
        if (branchId == 15 && response.equals("s_dffdee4b"))
        {
            if (racing_nashal_condition__defaultCondition(player, self))
            {
                ...
                if (hasResponse)
                {
                    ...
                    setObjVar(player, "conversation.racing_nashal.branchId", 18);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
