...
public class racing_lok extends script.base_script
{
    ...
    public boolean racing_lok_condition_hasRaced(obj_id player, obj_id npc) throws InterruptedException
    {
        return (hasObjVar(player, "racing.bestTime.lok"));
    }
    public boolean racing_lok_condition_isRacing(obj_id player, obj_id npc) throws InterruptedException
    {
        return (getIntObjVar(player, "racing.lok.isRacing") == 1);
    }
    public boolean racing_lok_condition_hasLastTime(obj_id player, obj_id npc) throws InterruptedException
    {
        return (hasObjVar(player, "racing.lastTime.lok"));
    }
    public void racing_lok_action_registerPersonalBest(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void racing_lok_action_startRace(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_displayCurrentLeader(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_whatsMyBestTime(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_showBestTime(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_erasePersonalBest(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_abortRace(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    public int OnInitialize(obj_id self) throws InterruptedException
    {
        ...
        {
            detachScript(self, "npc.conversation.racing_lok");
        }
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (racing_lok_condition_isRacing(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_6a5b9858");
            int numberOfResponses = 0;
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (racing_lok_condition__defaultCondition(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse0 = true;
            ...
            if (hasResponse)
            {
                ...
                setObjVar(player, "conversation.racing_lok.branchId", 1);
                npcStartConversation(player, self, "racing_lok", message, responses);
            }
            else 
            {
        ...
        if (racing_lok_condition_hasLastTime(player, self))
        {
            racing_lok_action_registerPersonalBest(player, self);
            string_id message = new string_id(c_stringFile, "s_891e1f6");
            chat.chat(self, message);
            return SCRIPT_CONTINUE;
        }
        if (racing_lok_condition_hasRaced(player, self))
        {
            ...
            if (hasResponse)
            {
                ...
                setObjVar(player, "conversation.racing_lok.branchId", 4);
                npcStartConversation(player, self, "racing_lok", message, responses);
            }
            else 
            {
        ...
        if (racing_lok_condition__defaultCondition(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_55824ba");
            int numberOfResponses = 0;
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (racing_lok_condition__defaultCondition(player, self))
            ...
            if (hasResponse)
            {
                ...
                setObjVar(player, "conversation.racing_lok.branchId", 15);
                npcStartConversation(player, self, "racing_lok", message, responses);
            }
            else 
            {
    ...
    {
        if (!conversationId.equals("racing_lok"))
        {
            return SCRIPT_CONTINUE;
        }
        int branchId = getIntObjVar(player, "conversation.racing_lok.branchId");
        if (branchId == 1 && response.equals("s_d900d1be"))
        {
            racing_lok_action_abortRace(player, self);
            if (racing_lok_condition__defaultCondition(player, self))
            {
                string_id message = new string_id(c_stringFile, "s_4aa68942");
                removeObjVar(player, "conversation.racing_lok.branchId");
        ...
        if (branchId == 4 && response.equals("s_ed644123"))
        {
            if (racing_lok_condition__defaultCondition(player, self))
            {
                ...
                if (hasResponse)
                {
                    ...
                    setObjVar(player, "conversation.racing_lok.branchId", 5);
                    npcSpeak(player, message);
        ...
        {
            racing_lok_action_displayCurrentLeader(player, self);
            if (racing_lok_condition__defaultCondition(player, self))
            {
        ...
        {
            racing_lok_action_whatsMyBestTime(player, self);
            if (racing_lok_condition__defaultCondition(player, self))
            {
        ...
        if (branchId == 4 && response.equals("s_59d4e0ee"))
        {
            if (racing_lok_condition__defaultCondition(player, self))
            {
                ...
                if (hasResponse)
                {
                    ...
                    setObjVar(player, "conversation.racing_lok.branchId", 10);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (branchId == 4 && response.equals("s_1736e216"))
        {
            if (racing_lok_condition__defaultCondition(player, self))
            {
                string_id message = new string_id(c_stringFile, "s_392149e8");
                int numberOfResponses = 0;
                boolean hasResponse = false;
                boolean hasResponse0 = false;
                if (racing_lok_condition__defaultCondition(player, self))
        ...
        {
            racing_lok_action_startRace(player, self);
            if (racing_lok_condition__defaultCondition(player, self))
            {
        ...
        {
            racing_lok_action_erasePersonalBest(player, self);
            if (racing_lok_condition__defaultCondition(player, self))
            {
        ...
        if (branchId == 14 && response.equals("s_ed644123"))
        {
            ...
            chat.chat(self, "Error:  All conditions for OnNpcConversationResponse for branch 'This is one of the longest and most arduous races in the galaxy. Don't bother with it unless you have the time and stamina. The Empire doesn't come here often, so it gets a lot of use from swoopers looking for an illegal race. The trouble is most of them do not complete the marathon. Beware of dangerous beasts, pirates, confusing mazes and a very large and active volcano.' were false.");
            return SCRIPT_CONTINUE;
        }
        ...
        if (branchId == 15 && response.equals("s_e460e3d3"))
        {
            ...
            chat.chat(self, "Error:  All conditions for OnNpcConversationResponse for branch 'Greetings, I'm the race coordinator for the Lok Marathon. If you'd like to race the track, just let me know. How may I serve you today?' were false.");
            return SCRIPT_CONTINUE;
        }
        ...
        if (branchId == 15 && response.equals("s_dffdee4b"))
        {
            if (racing_lok_condition__defaultCondition(player, self))
            {
                ...
                if (hasResponse)
                {
                    ...
                    setObjVar(player, "conversation.racing_lok.branchId", 18);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
