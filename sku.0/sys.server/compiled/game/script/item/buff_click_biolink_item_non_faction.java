...
public class buff_click_biolink_item_non_faction extends script.base_script
{
	public buff_click_biolink_item_non_faction()
	{
	}
	...
	public int OnAboutToBeTransferred(obj_id self, obj_id destContainer, obj_id transferer) throws InterruptedException
	{
		...
		if (biolink == utils.OBJ_ID_BIO_LINK_PENDING && isPlayer(destContainer))
		{
			...
			{
				sendSystemMessage(destContainer, SID_MUST_EQUIP_FROM_INVENTORY);
