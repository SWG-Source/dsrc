...
public class mining_gas_harvester_deed extends script.base_script
{
    public mining_gas_harvester_deed()
    {
    }
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        if (item == menu_info_types.ITEM_USE)
        {
            ...
            else 
            {
                ...
                String harvesterTemplate = new String("object/installation/mining_gas/mining_gas_harvester_style_1.iff");
