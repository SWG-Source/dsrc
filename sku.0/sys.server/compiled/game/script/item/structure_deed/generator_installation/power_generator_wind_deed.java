...
public class power_generator_wind_deed extends script.base_script
{
    public power_generator_wind_deed()
    {
    }
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        if (item == menu_info_types.ITEM_USE)
        {
            ...
            else 
            {
                ...
                String harvesterTemplate = new String("object/installation/generators/power_generator_wind_style_1.iff");
