...
public class trap_melee_def_1 extends script.item.trap.trap_base
{
    public trap_melee_def_1()
    {
    }
    public static final int TRAP_DIFF = 5;
    public static final string_id SID_SYS_EFFECT = new string_id("trap/trap", "trap_melee_def_1_effect");
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        if (!hasObjVar(self, "droid_trap"))
        {
            ...
            setObjVar(self, "trapName", "melee_def_1");
            setCount(self, 5);
        }
    ...
    public int trapHit(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        if (utils.hasScriptVar(target, "trapmod.melee_defense"))
        {
