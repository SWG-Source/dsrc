...
public class holiday extends script.base_script
{
    ...
    public static final string_id GIFT_GRANTED_REBEL = new string_id(EMP_DAY, "gift_granted_rebel");
    ...
    public static final float OBJECT_NEAR_CHECK_RANGE_250M = 250.0f;
    public static final float OBJECT_NEAR_CHECK_RANGE_200M = 200.0f;
    ...
    public static obj_id[] getEmpireDayWinningPlayers(obj_id holidayObject, Vector eligiblePlayers) throws InterruptedException
    {
        ...
        for (int i = 0; i < maxEmpireDayWinners; i++)
        {
            ...
            if (randomWinner > (eligiblePlayers.size() - 1))
            {
                continue;
            }
