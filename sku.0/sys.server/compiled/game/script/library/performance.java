...
public class performance extends script.base_script
{
    ...
    public static final String VAR_PERFORM_NO_GROUP_DANCE = "setting.performance.no_group_dance";
    ...
    public static final string_id SID_GROUP_DANCE_OFF = new string_id("performance", "dance_group_off");
    public static final string_id SID_GROUP_DANCE_ON = new string_id("performance", "dance_group_on");
    ...
    public static obj_id[] getDanceMembers(obj_id who) throws InterruptedException
    {
        ...
        {
            _validatedMembers = new obj_id[validatedMembers.size()];
            validatedMembers.toArray(_validatedMembers);
        }
