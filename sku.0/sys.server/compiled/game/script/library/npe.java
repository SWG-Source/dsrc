...
public class npe extends script.base_script
{
    ...
    {
        return utils.getIntConfigSetting("GameServer", "npeMinInstancePopulation"); // src set value, default is 20
    }
    public static int getMaxInstancePopulation() throws InterruptedException
    {
        return utils.getIntConfigSetting("GameServer", "npeMaxInstancePopulation"); // src set value, default is 50
    }
